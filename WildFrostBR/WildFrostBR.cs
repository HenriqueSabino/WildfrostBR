...
namespace WildfrostBR
{
    public class WildfrostBR : WildfrostMod
    {
        ...
        private void SetCardsLocalizations()
        {
            ...
            table.AddEntry("name_grumps", "Indisposto");
            ...
            table.AddEntry("cobalt.wildfrost.bloons.quincy_title", "Quincy");
            table.AddEntry("cobalt.wildfrost.bloons.quincy_flavour", "Nada escapa do seu arco!");
            table.AddEntry("cobalt.wildfrost.bloons.gwen_title", "Gwendolin");
            table.AddEntry("cobalt.wildfrost.bloons.jones_title", "Atirador Jones");
            table.AddEntry("cobalt.wildfrost.bloons.obyn_title", "Obyn");
            table.AddEntry("cobalt.wildfrost.bloons.bush_title", "Espinhos");
            table.AddEntry("cobalt.wildfrost.bloons.ben_title", "Benjamin");
            table.AddEntry("cobalt.wildfrost.bloons.adora_title", "Adora");
            table.AddEntry("cobalt.wildfrost.bloons.pat_title", "Pat Fusty");
            table.AddEntry("cobalt.wildfrost.bloons.ezili_title", "Ezili");
            table.AddEntry("cobalt.wildfrost.bloons.churchill_title", "Capitão Churchill");
            table.AddEntry("cobalt.wildfrost.bloons.brickell_title", "Almirante Brickell");
            table.AddEntry("cobalt.wildfrost.bloons.etienne_title", "Etienne");
            table.AddEntry("cobalt.wildfrost.bloons.sauda_title", "Sauda");
            table.AddEntry("cobalt.wildfrost.bloons.psi_title", "Psi");
            table.AddEntry("cobalt.wildfrost.bloons.geraldo_title", "Geraldo");
            table.AddEntry("cobalt.wildfrost.bloons.corvus_title", "Corvus");
            table.AddEntry("cobalt.wildfrost.bloons.greenball_title", "Espírito");
            table.AddEntry("cobalt.wildfrost.bloons.greenball_flavour", "Um carinha misterioso");
            table.AddEntry("cobalt.wildfrost.bloons.rosalia_title", "Rosalia");
            table.AddEntry("cobalt.wildfrost.bloons.agent_title", "Agente Jericho");
            table.AddEntry("cobalt.wildfrost.bloons.bloonstone_title", "Bonnie");
            table.AddEntry("cobalt.wildfrost.bloons.amelia_title", "Amelia");
            table.AddEntry("cobalt.wildfrost.bloons.smalldartman_title", "Macaco dos Dardos");
            table.AddEntry("cobalt.wildfrost.bloons.mediumdartman_title", "Super Fan Club dos Macacos");
            table.AddEntry("cobalt.wildfrost.bloons.bigdartman_title", "Espinhopulta");
            table.AddEntry("cobalt.wildfrost.bloons.glaive_title", "Lorde das Glaives");
            table.AddEntry("cobalt.wildfrost.bloons.boomer_title", "Kylie Bumerangue");
            table.AddEntry("cobalt.wildfrost.bloons.mauler_title", "Devorador de MDAO");
            table.AddEntry("cobalt.wildfrost.bloons.blitz_title", "Canhão de Bombas");
            table.AddEntry("cobalt.wildfrost.bloons.ring_title", "Anel de Fogo");
            table.AddEntry("cobalt.wildfrost.bloons.blade_title", "Atirador de Lâminas");
            table.AddEntry("cobalt.wildfrost.bloons.icegun_title", "Empalador de Gelo");
            table.AddEntry("cobalt.wildfrost.bloons.bigice_title", "Fragilizador");
            table.AddEntry("cobalt.wildfrost.bloons.gluehose_title", "Cano de Cola");
            table.AddEntry("cobalt.wildfrost.bloons.solver_title", "A Solução dos Bloons");
            table.AddEntry("cobalt.wildfrost.bloons.moab_title", "Mutilador de MDAOs");
            table.AddEntry("cobalt.wildfrost.bloons.elite_title", "Defensor de Elite");
            table.AddEntry("cobalt.wildfrost.bloons.energizer_title", "Energizador");
            table.AddEntry("cobalt.wildfrost.bloons.prestrike_title", "Ataque Preventivo");
            table.AddEntry("cobalt.wildfrost.bloons.buck1_title", "Piratas Macacos");
            table.AddEntry("cobalt.wildfrost.bloons.trade_title", "Império Comercial");
            table.AddEntry("cobalt.wildfrost.bloons.tsar_title", "Bomba Tsar");
            table.AddEntry("cobalt.wildfrost.bloons.skys_title", "Triturador de Céus");
            table.AddEntry("cobalt.wildfrost.bloons.specialpop_title", "Estorações Especiais");
            table.AddEntry("cobalt.wildfrost.bloons.razor_title", "Rotores Navalha");
            table.AddEntry("cobalt.wildfrost.bloons.razor_flavour", "Rasga inimigos ao contato");
            table.AddEntry("cobalt.wildfrost.bloons.marine_title", "Marinha");
            table.AddEntry("cobalt.wildfrost.bloons.fastmoarter_title", "Batalhao de Artilharia");
            table.AddEntry("cobalt.wildfrost.bloons.firemoarter_title", "Blooncinerador");
            table.AddEntry("cobalt.wildfrost.bloons.doom_title", "Raio Devastador");
            table.AddEntry("cobalt.wildfrost.bloons.shot_title", "Chumbo Grosso");
            table.AddEntry("cobalt.wildfrost.bloons.fwiz_title", "Sopro de Dragão");
            table.AddEntry("cobalt.wildfrost.bloons.dwiz_title", "Prícipe da Escuridão");
            table.AddEntry("cobalt.wildfrost.bloons.ubloon_title", "Bloon Zumbi");
            table.AddEntry("cobalt.wildfrost.bloons.temple_title", "Templo Solar");
            table.AddEntry("cobalt.wildfrost.bloons.batman2_title", "Lenda da Noite");
            table.AddEntry("cobalt.wildfrost.bloons.ninja1_title", "Bomba Pegajosa");
            table.AddEntry("cobalt.wildfrost.bloons.ninja2_title", "Grande Sabotador");
            table.AddEntry("cobalt.wildfrost.bloons.buffer_title", "Sopa Berserk");
            table.AddEntry("cobalt.wildfrost.bloons.rubber_title", "Borracha para Ouro");
            table.AddEntry("cobalt.wildfrost.bloons.forest_title", "Espírito da Floresta");
            table.AddEntry("cobalt.wildfrost.bloons.poplust_title", "Estourador");
            table.AddEntry("cobalt.wildfrost.bloons.merink_title", "Guerreiro Abissal");
            table.AddEntry("cobalt.wildfrost.bloons.merice_title", "Podeiboom");
            table.AddEntry("cobalt.wildfrost.bloons.bank_title", "Banco Macaco");
            table.AddEntry("cobalt.wildfrost.bloons.farm1_title", "Wall Street dos Macacos");
            table.AddEntry("cobalt.wildfrost.bloons.mib_title", "Escritório de Investigação Macaco");
            table.AddEntry("cobalt.wildfrost.bloons.city_title", "Cidade Macaco");
            table.AddEntry("cobalt.wildfrost.bloons.storm_title", "Chuva de Espinhos");
            table.AddEntry("cobalt.wildfrost.bloons.spikes_title", "Espinhos");
            table.AddEntry("cobalt.wildfrost.bloons.mines_title", "Minas Espinhosas");
            table.AddEntry("cobalt.wildfrost.bloons.bombspike_title", "Minas");
            table.AddEntry("cobalt.wildfrost.bloons.engie1_title", "Campeão das Sentinelas");
            table.AddEntry("cobalt.wildfrost.bloons.sentry_title", "Sentinela");
            table.AddEntry("cobalt.wildfrost.bloons.engie2_title", "Armadilha XXXG");
            table.AddEntry("cobalt.wildfrost.bloons.xxxl_title", "Armadilha");
            table.AddEntry("cobalt.wildfrost.bloons.bird_title", "Domador de Pouākai");
            table.AddEntry("cobalt.wildfrost.bloons.bud_title", "Pouākai");
            table.AddEntry("cobalt.wildfrost.bloons.fish_title", "Domador de Orcas");
            table.AddEntry("cobalt.wildfrost.bloons.blud_title", "Orca");
            table.AddEntry("cobalt.wildfrost.bloons.bigtotem_title", "Totem Sacrificial");
            table.AddEntry("cobalt.wildfrost.bloons.boomsentry_title", "Sentinela Boom");
            table.AddEntry("cobalt.wildfrost.bloons.crushingsentry_title", "Sentinela Esmagadora");
            table.AddEntry("cobalt.wildfrost.bloons.coldsentry_title", "Sentinela Gelada");
            table.AddEntry("cobalt.wildfrost.bloons.energysentry_title", "Sentinela Energética");
            table.AddEntry("cobalt.wildfrost.bloons.epineapple_title", "Abacaxi Explosivo");
            table.AddEntry("cobalt.wildfrost.bloons.rspikes_title", "Espinhos de Estrada");
            table.AddEntry("cobalt.wildfrost.bloons.rspikes_flavour", "Afiado ao Toque");
            table.AddEntry("cobalt.wildfrost.bloons.harpoon1_title", "Arpão");
            table.AddEntry("cobalt.wildfrost.bloons.shell1_title", "Carapaça de Bala");
            table.AddEntry("cobalt.wildfrost.bloons.shell2_title", "Bala Flamejante");
            table.AddEntry("cobalt.wildfrost.bloons.missile_title", "Míssel Balístico");
            table.AddEntry("cobalt.wildfrost.bloons.bomba_title", "Nuke");
            table.AddEntry("cobalt.wildfrost.bloons.scan_title", "Biohack");
            table.AddEntry("cobalt.wildfrost.bloons.cocktail_title", "Coquetel de Fogo");
            table.AddEntry("cobalt.wildfrost.bloons.firestorm_title", "Tempestade de Fogo");
            table.AddEntry("cobalt.wildfrost.bloons.crates_title", "Caixa de Suprimentos");
            table.AddEntry("cobalt.wildfrost.bloons.blility_title", "Redemoinho de Lâminas");
            table.AddEntry("cobalt.wildfrost.bloons.snowstorm_title", "Tempestade de Gelo");
            table.AddEntry("cobalt.wildfrost.bloons.zero_title", "Zero Absoluto");
            table.AddEntry("cobalt.wildfrost.bloons.stotem_title", "Invocação de Totem");
            table.AddEntry("cobalt.wildfrost.bloons.esentry_title", "Sentinela Elemental");
            table.AddEntry("cobalt.wildfrost.bloons.lightarm_title", "Longo Braço da Luz");
            table.AddEntry("cobalt.wildfrost.bloons.techbot_title", "Robô Tecnológico");
            table.AddEntry("cobalt.wildfrost.bloons.trip_title", "Tiro Triplo");
            table.AddEntry("cobalt.wildfrost.bloons.trip_flavour", "Três é melhor do que um!");
            table.AddEntry("cobalt.wildfrost.bloons.aspike_title", "Espinho Arcano");
            table.AddEntry("cobalt.wildfrost.bloons.dissolver_title", "Dissolvedor de Bloon");
            table.AddEntry("cobalt.wildfrost.bloons.dat_title", "Dardo");
            table.AddEntry("cobalt.wildfrost.bloons.dat_flavour", "Estoura bloons com facilidade");
            table.AddEntry("cobalt.wildfrost.bloons.hotshot_title", "Tiro Quente");
            table.AddEntry("cobalt.wildfrost.bloons.sacrifice_title", "Sacrifício de Sangue");
            table.AddEntry("cobalt.wildfrost.bloons.heartstopper_title", "Para Coração");
            table.AddEntry("cobalt.wildfrost.bloons.unstable_title", "Mistura Instável");
            table.AddEntry("cobalt.wildfrost.bloons.syphon_title", "Financiamento Sifão");
            table.AddEntry("cobalt.wildfrost.bloons.pineappledeploy_title", "Lançamento de Abacaxi");
            table.AddEntry("cobalt.wildfrost.bloons.echos_title", "Rede de Sonar");
            table.AddEntry("cobalt.wildfrost.bloons.finalh_title", "Harmonico Final");
            table.AddEntry("cobalt.wildfrost.bloons.supply_title", "Entrega de Suprimentos");
            table.AddEntry("cobalt.wildfrost.bloons.bananap_title", "Plantação de Banana");
            table.AddEntry("cobalt.wildfrost.bloons.vbananas_title", "Bananas Valiosas");
            table.AddEntry("cobalt.wildfrost.bloons.hex_title", "Feitiço");
            table.AddEntry("cobalt.wildfrost.bloons.crush_title", "Esmagamento de Bloon");
            table.AddEntry("cobalt.wildfrost.bloons.shinobi_title", "Táticas Shinobi");
            table.AddEntry("cobalt.wildfrost.bloons.distraction_title", "Distração");
            table.AddEntry("cobalt.wildfrost.bloons.sabo_title", "Sabotagem de Bloon");
            table.AddEntry("cobalt.wildfrost.bloons.stim_title", "Estimulante Aprimorado");
            table.AddEntry("cobalt.wildfrost.bloons.heartofoak_title", "Coração de Carvalho");
            table.AddEntry("cobalt.wildfrost.bloons.gluestrike_title", "Disparo de Cola");
            table.AddEntry("cobalt.wildfrost.bloons.superglue_title", "Super Cola");
            table.AddEntry("cobalt.wildfrost.bloons.cluster_title", "Conjuto de Bombas");
            table.AddEntry("cobalt.wildfrost.bloons.ppt_title", "Totem de Poder Paragon");
            table.AddEntry("cobalt.wildfrost.bloons.bunny_title", "Coelho de Estimação");
            table.AddEntry("cobalt.wildfrost.bloons.downdraft_title", "Corrente Descendente");
            table.AddEntry("cobalt.wildfrost.bloons.drums_title", "Tambores da Selva");
            table.AddEntry("cobalt.wildfrost.bloons.primary_title", "Treinamento Primário");
            table.AddEntry("cobalt.wildfrost.bloons.shimmer_title", "Cintila");
            table.AddEntry("cobalt.wildfrost.bloons.sprockets_title", "Engrenagem");
            table.AddEntry("cobalt.wildfrost.bloons.overclock_title", "Aprimorar");
            table.AddEntry("cobalt.wildfrost.bloons.shellshock_title", "Shell Shock");
            table.AddEntry("cobalt.wildfrost.bloons.1harpoon1_title", "Arpão");
            table.AddEntry("cobalt.wildfrost.bloons.1shell1_title", "Carapaça de Bala");
            table.AddEntry("cobalt.wildfrost.bloons.1shell2_title", "Bala Flamejante");
            table.AddEntry("cobalt.wildfrost.bloons.1missile_title", "Míssel Balístico");
            table.AddEntry("cobalt.wildfrost.bloons.tidal_title", "Maré Fria");
            table.AddEntry("shortcake.another.snowfall.SpoofEnemy_title", "Spoof");
            table.AddEntry("shortcake.another.snowfall.VanJunEnemy_title", "Van Jun");
            table.AddEntry("shortcake.another.snowfall.SplinterEnemy_title", "Splinter");
            table.AddEntry("shortcake.another.snowfall.DevicroEnemy_title", "Devicro");
            table.AddEntry("shortcake.another.snowfall.JunjunEnemy_title", "Junjun");
            table.AddEntry("shortcake.another.snowfall.FallowEnemy_title", "Fallow");
            table.AddEntry("shortcake.another.snowfall.PomEnemy_title", "Pom");
            table.AddEntry("shortcake.another.snowfall.MonchEnemy_title", "Monch");
            table.AddEntry("shortcake.another.snowfall.ChikichiEnemy_title", "Chikichi");
            table.AddEntry("shortcake.another.snowfall.WeakChikani_title", "Chikani");
            table.AddEntry("shortcake.another.snowfall.WeakChikasan_title", "Chikasan");
            table.AddEntry("shortcake.another.snowfall.EggEnemy_title", "Ovo");
            table.AddEntry("shortcake.another.snowfall.DreggEnemy_title", "Drovo");
            table.AddEntry("shortcake.another.snowfall.GroffEnemy_title", "Groff");
            table.AddEntry("shortcake.another.snowfall.LeechEnemy_title", "Sanguessuga");
            table.AddEntry("shortcake.another.snowfall.BombomEnemy2_title", "Bombom");
            table.AddEntry("shortcake.another.snowfall.SnoofEnemy2_title", "Lobisgelo");
            table.AddEntry("shortcake.another.snowfall.BooshuEnemy_title", "Booshu");
            table.AddEntry("shortcake.another.snowfall.LokiEnemy_title", "Loki");
            table.AddEntry("shortcake.another.snowfall.SneezleEnemy_title", "Espirrito");
            table.AddEntry("shortcake.another.snowfall.SpikeEnemy_title", "Espinho");
            table.AddEntry("shortcake.another.snowfall.BinkuEnemy_title", "Tintu");
            table.AddEntry("shortcake.another.snowfall.LilGaziEnemy_title", "Gazinha");
            table.AddEntry("shortcake.another.snowfall.WortEnemy_title", "Mofu");
            table.AddEntry("shortcake.another.snowfall.FulbertEnemy_title", "Fulbert");
            table.AddEntry("shortcake.another.snowfall.FulbertEnemy2_title", "Fulbert");
            table.AddEntry("shortcake.another.snowfall.FungunEnemy_title", "Fungarma");
            table.AddEntry("shortcake.another.snowfall.ShroomineEnemy_title", "Fungarmadilha");
            table.AddEntry("shortcake.another.snowfall.FungoBlasterEnemy_title", "Canhão de Fungo");
            table.AddEntry("shortcake.another.snowfall.ShroominatorEnemy_title", "Fungiplicador");
            table.AddEntry("shortcake.another.snowfall.BigBerryEnemy_title", "Grande Baga");
            table.AddEntry("shortcake.another.snowfall.BerrySisEnemy_title", "Mana Baga");
            table.AddEntry("shortcake.another.snowfall.GojiberEnemy_title", "Gojiba");
            table.AddEntry("shortcake.another.snowfall.BonnieEnemy2_title", "Bonnie");
            table.AddEntry("shortcake.another.snowfall.HeartmistStationEnemy_title", "Incensário Coração");
            table.AddEntry("shortcake.another.snowfall.LilBerryEnemy_title", "Baguinha");
            table.AddEntry("shortcake.another.snowfall.WallopEnemy_title", "Wallop");
            table.AddEntry("shortcake.another.snowfall.YukiEnemy_title", "Yuki");
            table.AddEntry("shortcake.another.snowfall.SnoofEnemy_title", "Lobisgelo");
            table.AddEntry("shortcake.another.snowfall.SnobbleEnemy_title", "Nevruno");
            table.AddEntry("shortcake.another.snowfall.SnoffelEnemy_title", "Nevô");
            table.AddEntry("shortcake.another.snowfall.WoodheadEnemy_title", "Cabeçudo");
            table.AddEntry("shortcake.another.snowfall.KobonkerEnemy_title", "Kobonker");
            table.AddEntry("shortcake.another.snowfall.TotemOfTheGoatEnemy_title", "Totem da Cabra");
            table.AddEntry("shortcake.another.snowfall.BlingBankEnemy_title", "Banco Bling");
            table.AddEntry("shortcake.another.snowfall.NovaEnemy2_title", "Nova");
            table.AddEntry("shortcake.another.snowfall.RoibosEnemy_title", "Roibos");
            table.AddEntry("shortcake.another.snowfall.LilGaziEnemy2_title", "Gazinha");
            table.AddEntry("shortcake.another.snowfall.PyraEnemy2_title", "Pyra");
            table.AddEntry("shortcake.another.snowfall.FirefistEnemy_title", "Punhoquente");
            table.AddEntry("shortcake.another.snowfall.TinyTykoEnemy_title", "Pequeno Tyko");
            table.AddEntry("shortcake.another.snowfall.PyraEnemy_title", "Pyra");
            table.AddEntry("shortcake.another.snowfall.HeartforgeEnemy_title", "Forja-coração");
            table.AddEntry("shortcake.another.snowfall.PepperFlagEnemy_title", "Bandeira Pimenta");
            table.AddEntry("shortcake.another.snowfall.PimentoEnemy_title", "Pimento");
            table.AddEntry("shortcake.another.snowfall.MokoTotemEnemy_title", "Totem Moko");
            table.AddEntry("shortcake.another.snowfall.KernelEnemy2_title", "Grão");
            table.AddEntry("shortcake.another.snowfall.ShellyEnemy2_title", "Shelly");
            table.AddEntry("shortcake.another.snowfall.FungunEnemy2_title", "Fungarma");
            table.AddEntry("shortcake.another.snowfall.ShroominatorEnemy2_title", "Fungiplicador");
            table.AddEntry("shortcake.another.snowfall.MimikEnemy_title", "Mimiko");
            table.AddEntry("shortcake.another.snowfall.FoxeeEnemy2_title", "Rapozee");
            table.AddEntry("shortcake.another.snowfall.HazeblazerEnemy_title", "Dedetizador");
            table.AddEntry("shortcake.another.snowfall.BlunkyEnemy_title", "Bloqui");
            table.AddEntry("shortcake.another.snowfall.HazeBalloonEnemy_title", "Balão de Névoa");
            table.AddEntry("shortcake.another.snowfall.AlloyEnemy_title", "Alloy");
            table.AddEntry("shortcake.another.snowfall.TootordionEnemy_title", "Flautínfona");
            table.AddEntry("shortcake.another.snowfall.FizzleEnemy_title", "Fizzle");
            table.AddEntry("shortcake.another.snowfall.BombarderEnemy_title", "Bombardeiro");
            table.AddEntry("shortcake.another.snowfall.BijiEnemy_title", "Biji");
            table.AddEntry("shortcake.another.snowfall.TaigaEnemy_title", "Taiga");
            table.AddEntry("shortcake.another.snowfall.LupaEnemy_title", "Lupa");
            table.AddEntry("shortcake.another.snowfall.SpikeEnemy2_title", "Espinho");
            table.AddEntry("shortcake.another.snowfall.TuskEnemy_title", "Presa");
            table.AddEntry("shortcake.another.snowfall.KnucklesEnemy2_title", "Sokos");
            table.AddEntry("shortcake.another.snowfall.ChompomEnemy_title", "Champom");
            table.AddEntry("shortcake.another.snowfall.KernelEnemy_title", "Grão");
            table.AddEntry("shortcake.another.snowfall.ShellyEnemy_title", "Shelly");
            table.AddEntry("shortcake.another.snowfall.SpiceSparklersEnemy_title", "Fogos Picantes");
            table.AddEntry("shortcake.another.snowfall.ShellforgeEnemy_title", "Forja-coração");
            table.AddEntry("shortcake.another.snowfall.NovaEnemy_title", "Nova");
            table.AddEntry("shortcake.another.snowfall.DimonaEnemy_title", "Dimona");
            table.AddEntry("shortcake.another.snowfall.FoxeeEnemy_title", "Rapozee");
            table.AddEntry("shortcake.another.snowfall.ShellPyraEnemy_title", "Pyra");
            table.AddEntry("shortcake.another.snowfall.BombomEnemy_title", "Bombom");
            table.AddEntry("shortcake.another.snowfall.NeedleEnemy_title", "Agulha");
            table.AddEntry("shortcake.another.snowfall.NomStompyEnemy2_title", "Nom & Pisão");
            table.AddEntry("shortcake.another.snowfall.NomStompyEnemy3_title", "Nom & Pisão");
            table.AddEntry("shortcake.another.snowfall.FolbyEnemy2_title", "Folby");
            table.AddEntry("shortcake.another.snowfall.KreggoEnemy2_title", "Kreggo");
            table.AddEntry("shortcake.another.snowfall.KreggoEnemy3_title", "Kreggo");
            table.AddEntry("shortcake.another.snowfall.BlundertankEnemy_title", "Tanque de Erros");
            table.AddEntry("shortcake.another.snowfall.GachapomperEnemy_title", "Gachabomba");
            table.AddEntry("shortcake.another.snowfall.ShenEnemy_title", "Shen");
            table.AddEntry("shortcake.another.snowfall.VestaEnemy_title", "Vesta");
            table.AddEntry("shortcake.another.snowfall.OverJunjunEnemy_title", "Junjun");
            table.AddEntry("shortcake.another.snowfall.OverFallowEnemy_title", "Fallow");
            table.AddEntry("shortcake.another.snowfall.ZulaEnemy_title", "Zula");
            table.AddEntry("shortcake.another.snowfall.BeepopEnemy_title", "Beepop");
            table.AddEntry("shortcake.another.snowfall.MonchEnemy2_title", "Monch");
            table.AddEntry("shortcake.another.snowfall.StrongChikichiEnemy_title", "Chikichi");
            table.AddEntry("shortcake.another.snowfall.StrongChikani_title", "Chikani");
            table.AddEntry("shortcake.another.snowfall.StrongChikasan_title", "Chikasan");
            table.AddEntry("shortcake.another.snowfall.StrongChikashi_title", "Chikashi");
            table.AddEntry("shortcake.another.snowfall.StrongChikagoru_title", "Chikagoru");
            table.AddEntry("shortcake.another.snowfall.VanJunEnemy2_title", "Van Jun");
            table.AddEntry("shortcake.another.snowfall.GroffEnemy2_title", "Groff");
            table.AddEntry("shortcake.another.snowfall.SheepopperEnemy_title", "Ovebomba");
            table.AddEntry("shortcake.another.snowfall.StrongJunjunEnemy_title", "Junjun");
            table.AddEntry("shortcake.another.snowfall.StrongFallowEnemy_title", "Fallow");
            table.AddEntry("shortcake.another.snowfall.DevicroEnemy2_title", "Devicro");
            table.AddEntry("shortcake.another.snowfall.ToasterEnemy_title", "Torradeira");
            table.AddEntry("shortcake.another.snowfall.ScavenEnemy_title", "Scaven");
            table.AddEntry("shortcake.another.snowfall.FolbyEnemy_title", "Folby");
            table.AddEntry("shortcake.another.snowfall.MobileCampfireEnemy_title", "Fogueira Móvel");
            table.AddEntry("shortcake.another.snowfall.TinkersonJrEnemy_title", "Tinkerson Jr.");
            table.AddEntry("shortcake.another.snowfall.JumboEnemy_title", "Jumbo");
            table.AddEntry("shortcake.another.snowfall.JumboEnemy2_title", "Jumbo");
            table.AddEntry("shortcake.another.snowfall.PortableWorkbenchEnemy_title", "Bancada Portátil");
            table.AddEntry("shortcake.another.snowfall.KnucklesEnemy_title", "Sokos");
            table.AddEntry("shortcake.another.snowfall.PlinkerEnemy_title", "Plinko");
            table.AddEntry("shortcake.another.snowfall.KronoEnemy_title", "Krono");
            table.AddEntry("shortcake.another.snowfall.RoibosEnemy2_title", "Roibos");
            table.AddEntry("shortcake.another.snowfall.MiniMikaEnemy_title", "Mini Mika");
            table.AddEntry("shortcake.another.snowfall.NomStompyEnemy_title", "Nom & Pisão");
            table.AddEntry("shortcake.another.snowfall.KreggoEnemy_title", "Kreggo");
            table.AddEntry("shortcake.another.snowfall.ToasterEnemy2_title", "Torradeira");
            table.AddEntry("shortcake.another.snowfall.ToasterEnemy2_text", "Adicione <keyword=consume>");
            table.AddEntry("shortcake.another.snowfall.BonnieEnemy_title", "Bonnie");
            table.AddEntry("shortcake.another.snowfall.ICGMEnemy_title", "M.I.C.G");
            table.AddEntry("shortcake.another.snowfall.TheBakerEnemy_title", "O Cozinheiro");
            table.AddEntry("shortcake.another.snowfall.MamaTinkersonEnemy_title", "Mamãe Tinkerson");
            table.AddEntry("shortcake.another.snowfall.SpoofEnemy2_title", "Spoof");
            table.AddEntry("shortcake.another.snowfall.PootieEnemy_title", "Pootie");
            table.AddEntry("shortcake.another.snowfall.BlunkyEnemy2_title", "Bloqui");
            table.AddEntry("shortcake.another.snowfall.HazeblazerEnemy2_title", "Dedetizador");
            table.AddEntry("shortcake.another.snowfall.BlizzardBottleEnemy_title", "Garrafa de Nevasca");
            table.AddEntry("shortcake.another.snowfall.ShadeWispEnemy_title", "Fada Sombra");
            table.AddEntry("shortcake.another.snowfall.BlankMaskEnemy_title", "Máscara Vazia");
            table.AddEntry("shortcake.another.snowfall.BonescraperEnemy_title", "Raspa-ossos");
            table.AddEntry("shortcake.another.snowfall.GrabberEnemy_title", "Pegador");
            table.AddEntry("shortcake.another.snowfall.BerryBellEnemy_title", "Berry Sino Baga");
            table.AddEntry("shortcake.another.snowfall.NoomlinBiscuitEnemy_title", "Biscoito Noomlin");
            table.AddEntry("shortcake.another.snowfall.ZoomlinWafersEnemy_title", "Biscoitos Zoomlin");
            table.AddEntry("shortcake.another.snowfall.SuncreamEnemy_title", "Sorvesol");
            table.AddEntry("shortcake.another.snowfall.SporePackEnemy_title", "Bolsa de Esporos");
            table.AddEntry("shortcake.another.snowfall.HongosHammerEnemy_title", "Martelo do Fungo");
            table.AddEntry("shortcake.another.snowfall.SunRodEnemy_title", "Cajado Solar");
            table.AddEntry("shortcake.another.snowfall.PinkberryJuiceEnemy_title", "Suco de Baga Rosa");
            table.AddEntry("shortcake.another.snowfall.BerryBasketEnemy_title", "Cesto de Bagas");
            table.AddEntry("shortcake.another.snowfall.BerryBladeEnemy_title", "Lâmina Baga");
            table.AddEntry("shortcake.another.snowfall.SnowStickEnemy_title", "Graveto de Neve");
            table.AddEntry("shortcake.another.snowfall.SnowGlobeEnemy_title", "Globo de Tempestade");
            table.AddEntry("shortcake.another.snowfall.SnowcakeEnemy_title", "Bolo de Neve");
            table.AddEntry("shortcake.another.snowfall.MoltenDipEnemy_title", "Molho Derretido");
            table.AddEntry("shortcake.another.snowfall.ForgingStoveEnemy_title", "Fogão de Forja");
            table.AddEntry("shortcake.another.snowfall.DemonheartEnemy_title", "Coração Demoníaco");
            table.AddEntry("shortcake.another.snowfall.PeppereaperEnemy_title", "Ceifador Pimenta");
            table.AddEntry("shortcake.another.snowfall.PepperingEnemy_title", "Anel de Pimenta");
            table.AddEntry("shortcake.another.snowfall.DragonPepperEnemy_title", "Pimenta Dragão");
            table.AddEntry("shortcake.another.snowfall.SpiceStonesEnemy_title", "Pedras Picantes");
            table.AddEntry("shortcake.another.snowfall.ShellShieldEnemy_title", "Escudo Pequeno");
            table.AddEntry("shortcake.another.snowfall.FoggyBrewEnemy_title", "Bebida Fumacenta");
            table.AddEntry("shortcake.another.snowfall.GigisCookieBoxEnemy_title", "Caixa de Biscoitos da Gigi");
            table.AddEntry("shortcake.another.snowfall.BomBarrelEnemy_title", "Barril de Bom");
            table.AddEntry("shortcake.another.snowfall.PepperingShellEnemy_title", "Anel de Pimenta");
            table.AddEntry("shortcake.another.snowfall.LuminLanternEnemy_title", "Lanterna Lumin");
            table.AddEntry("shortcake.another.snowfall.TigerSkullEnemy_title", "Caveira de Tigre");
            table.AddEntry("shortcake.another.snowfall.NutshellCakeEnemy_title", "Bolo Casca de Noz");
            table.AddEntry("shortcake.another.snowfall.PombombEnemy_title", "Pombomb");
            table.AddEntry("shortcake.another.snowfall.ShellboEnemy_title", "Bombacasca");
            table.AddEntry("shortcake.another.snowfall.IceDiceEnemy_title", "Dado Gélido");
            table.AddEntry("shortcake.another.snowfall.MiniMuncherEnemy_title", "Mini Devorador");
            table.AddEntry("shortcake.another.snowfall.AzulBattleAxeEnemy_title", "Machado de Batalha Azul");
            table.AddEntry("shortcake.another.snowfall.AzulCandleEnemy_title", "Vela Azul");
            table.AddEntry("shortcake.another.snowfall.BeepopMaskEnemy_title", "Máscara de Beepop");
            table.AddEntry("shortcake.another.snowfall.AzulSkullEnemy_title", "Caveira Azul");
            table.AddEntry("shortcake.another.snowfall.ShadeWispEnemy2_title", "Fada Sombra");
            table.AddEntry("shortcake.another.snowfall.SkullMuffinEnemy_title", "Muffin Caveira");
            table.AddEntry("shortcake.another.snowfall.SkullmistTeaEnemy_title", "Chá Névoa-Caveira ");
            table.AddEntry("shortcake.another.snowfall.BonescraperEnemy2_title", "Raspa-ossos");
            table.AddEntry("shortcake.another.snowfall.BlazeTeaEnemy_title", "Chá de Fogo");
            table.AddEntry("shortcake.another.snowfall.BINKEnemy_title", "B.I.N.K");
            table.AddEntry("shortcake.another.snowfall.MagmaBoosterEnemy_title", "Aprimorador de Magma");
            table.AddEntry("shortcake.another.snowfall.NimbusLeader_title", "Nimbus");
            table.AddEntry("shortcake.another.snowfall.BamLeader_title", "Em");
            table.AddEntry("shortcake.another.snowfall.BoozleLeader_title", "Buste");
            table.AddEntry("shortcake.another.snowfall.RingerLeader_title", "O Tocador de Sinos");
            table.AddEntry("shortcake.another.snowfall.RazorLeader_title", "Razor");
            table.AddEntry("shortcake.another.snowfall.QueenGloberryLeader_title", "Rainha Globaga");
            table.AddEntry("shortcake.another.snowfall.BogberryLeader_title", "Baga do Pântano");
            table.AddEntry("shortcake.another.snowfall.BolgoLeader_title", "Bolgo");
            table.AddEntry("shortcake.another.snowfall.VeiledLadyLeader_title", "Dama Velada");
            table.AddEntry("shortcake.another.snowfall.NumskullLeader_title", "Cabeça Fria");
            table.AddEntry("shortcake.another.snowfall.KingMokoLeader_title", "Rei Moko");
            table.AddEntry("shortcake.another.snowfall.LumakoLeader_title", "Lumako");
            table.AddEntry("shortcake.another.snowfall.MawJawLeader_title", "Bocão Mandíbula");
            table.AddEntry("shortcake.another.snowfall.WeevilLeader_title", "Caruncho");
            table.AddEntry("shortcake.another.snowfall.MuttonheadLeader_title", "Cabeça-de-Cabra");
            table.AddEntry("shortcake.another.snowfall.FrostJailerLeader_title", "Carcereiro Congelado");
            table.AddEntry("shortcake.another.snowfall.FrostCrusherLeader_title", "Esmagador Congelado");
            table.AddEntry("shortcake.another.snowfall.FrostLancerLeader_title", "Lanceiro Congelado");
            table.AddEntry("shortcake.another.snowfall.FrostBomberLeader_title", "Bombardeiro Congelado");
            table.AddEntry("shortcake.another.snowfall.FrostJunkerLeader_title", "Sujador Congelado");
            table.AddEntry("shortcake.another.snowfall.FrostMuncherLeader_title", "Devorador Congelado");
            table.AddEntry("shortcake.another.snowfall.FrostGuardianLeader_title", "Guardião Congelado");
            table.AddEntry("shortcake.another.snowfall.FrostGuardianLeader2_title", "Guardião Congelado");
            table.AddEntry("shortcake.another.snowfall.InfernokoLeader_title", "Infernoko");
            table.AddEntry("shortcake.another.snowfall.InfernokoLeader2_title", "Infernoko");
            table.AddEntry("shortcake.another.snowfall.PengoonPet_title", "Pinguentão");
            table.AddEntry("shortcake.another.snowfall.LumpPet_title", "Caroço");
            table.AddEntry("shortcake.another.snowfall.PorkypinePet_title", "Porcopinho");
            table.AddEntry("shortcake.another.snowfall.BeeberryPet_title", "Bagabelha");
            table.AddEntry("shortcake.another.snowfall.SnowbirbPet_title", "Passarogelo");
            table.AddEntry("shortcake.another.snowfall.MinimokoPet_title", "Minimoko");
            table.AddEntry("shortcake.another.snowfall.FrostingerPet_title", "Congelador");
            table.AddEntry("shortcake.another.snowfall.NakedGnomePet_title", "Gnomo Pelado");
            table.AddEntry("shortcake.another.snowfall.NakedGnomePet_flavour", "Faz absolutamente nada...");
            table.AddEntry("shortcake.another.snowfall.BabySnowboAlly_title", "Nevobo Bebê");
            table.AddEntry("shortcake.another.snowfall.BabySnowboAlly2_title", "Nevobo Bebê");
            table.AddEntry("shortcake.another.snowfall.SnowboAlly_title", "Nevobo");
            table.AddEntry("shortcake.another.snowfall.HogStarterAlly2_title", "Porco");
            table.AddEntry("shortcake.another.snowfall.WarthogStarterAlly_title", "Javali");
            table.AddEntry("shortcake.another.snowfall.BeeberryStarterAlly2_title", "Bagabelha");
            table.AddEntry("shortcake.another.snowfall.PuffballStarterAlly_title", "Esporo");
            table.AddEntry("shortcake.another.snowfall.TentickleAllyDebuffed_title", "Tentosco");
            table.AddEntry("shortcake.another.snowfall.BerryWitchAlly_title", "Bruxa Baga");
            table.AddEntry("shortcake.another.snowfall.BigfootAlly_title", "Pé-grande");
            table.AddEntry("shortcake.another.snowfall.BlazeBeetlesAlly_title", "Besouros Flamejantes");
            table.AddEntry("shortcake.another.snowfall.BulbheadAlly_title", "Cabeça-de-Bulbo");
            table.AddEntry("shortcake.another.snowfall.BursterAlly_title", "Destruidor");
            table.AddEntry("shortcake.another.snowfall.ChungoonAlly_title", "Fortarrão");
            table.AddEntry("shortcake.another.snowfall.ConkerAlly_title", "Cascudo");
            table.AddEntry("shortcake.another.snowfall.DungrokAlly_title", "Rochestrume");
            table.AddEntry("shortcake.another.snowfall.EarthBerryAlly_title", "Baga Terrestre");
            table.AddEntry("shortcake.another.snowfall.GobblerAlly_title", "Comilão");
            table.AddEntry("shortcake.another.snowfall.GoblingAlly_title", "Gobling");
            table.AddEntry("shortcake.another.snowfall.GogongAlly_title", "Gogong");
            table.AddEntry("shortcake.another.snowfall.GokAlly_title", "Gok");
            table.AddEntry("shortcake.another.snowfall.GrinkAlly_title", "Grink");
            table.AddEntry("shortcake.another.snowfall.GrizzleAlly_title", "Grisalho");
            table.AddEntry("shortcake.another.snowfall.GrogAlly_title", "Grog");
            table.AddEntry("shortcake.another.snowfall.GrombleAlly_title", "Gromble");
            table.AddEntry("shortcake.another.snowfall.GrouchyAlly_title", "Rabugento");
            table.AddEntry("shortcake.another.snowfall.GrumpsAlly_title", "Indisposto");
            table.AddEntry("shortcake.another.snowfall.GunkGobblerAlly_title", "Comilão de Gosma");
            table.AddEntry("shortcake.another.snowfall.GunkbackAlly_title", "Gorduroso");
            table.AddEntry("shortcake.another.snowfall.HogAlly_title", "Porco");
            table.AddEntry("shortcake.another.snowfall.JabJoatAlly_title", "Boxbode");
            table.AddEntry("shortcake.another.snowfall.KrabAlly_title", "Karangueijo");
            table.AddEntry("shortcake.another.snowfall.KrakenAlly_title", "Kraken");
            table.AddEntry("shortcake.another.snowfall.KrawlerAlly_title", "Krawler");
            table.AddEntry("shortcake.another.snowfall.MakokoAlly_title", "Makoko");
            table.AddEntry("shortcake.another.snowfall.MarrowAlly_title", "Medula");
            table.AddEntry("shortcake.another.snowfall.OctakoAlly_title", "Octako");
            table.AddEntry("shortcake.another.snowfall.OobaBearAlly_title", "Urso Ooba");
            table.AddEntry("shortcake.another.snowfall.PawPawAlly_title", "Gato-Espinho");
            table.AddEntry("shortcake.another.snowfall.PecanAlly_title", "Pecã");
            table.AddEntry("shortcake.another.snowfall.PepperWitchAlly_title", "Bruxa Pimenta");
            table.AddEntry("shortcake.another.snowfall.PlumWitchAlly_title", "Ameixa");
            table.AddEntry("shortcake.another.snowfall.PopshroomAlly_title", "Fungolha");
            table.AddEntry("shortcake.another.snowfall.PrickleAlly_title", "Espinhento");
            table.AddEntry("shortcake.another.snowfall.PygmyAlly_title", "Pigmeu");
            table.AddEntry("shortcake.another.snowfall.RockhogAlly_title", "Porcrocha");
            table.AddEntry("shortcake.another.snowfall.ShellWitchAlly_title", "Bruxa Cascuda");
            table.AddEntry("shortcake.another.snowfall.ShrootlesAlly_title", "Cogumelos");
            table.AddEntry("shortcake.another.snowfall.SmogAlly_title", "Gatévua");
            table.AddEntry("shortcake.another.snowfall.SpuncherAlly_title", "Soconja");
            table.AddEntry("shortcake.another.snowfall.TentickleAlly_title", "Tentosco");
            table.AddEntry("shortcake.another.snowfall.WaddlegoonsAlly_title", "Cambaleões");
            table.AddEntry("shortcake.another.snowfall.WillowAlly_title", "Tristela");
            table.AddEntry("shortcake.another.snowfall.WinterWormAlly_title", "Verme de Neve");
            table.AddEntry("shortcake.another.snowfall.SnowGobblerAlly_title", "Comilão de Neve");
            table.AddEntry("shortcake.another.snowfall.ShroomGobblerAlly_title", "Comilão de Fungo");
            table.AddEntry("shortcake.another.snowfall.WoollyDrekAlly_title", "Drek Lanoso");
            table.AddEntry("shortcake.another.snowfall.WildSnoolfAlly_title", "Lobisgelo Selvagem");
            table.AddEntry("shortcake.another.snowfall.BabySnowboAlly3_title", "Nevobo Bebê");
            table.AddEntry("shortcake.another.snowfall.PinkberryJuiceDebuffed_title", "Suco de Baga Rosa");
            table.AddEntry("shortcake.another.snowfall.ShellShieldDebuffed_title", "Escudo Pequeno");
            table.AddEntry("shortcake.another.snowfall.BranchOfNutsDebuffed_title", "Galho de Nozes");
            table.AddEntry("shortcake.another.snowfall.SlapcrackersDebuffed_title", "Tapa Rotatório");
            table.AddEntry("shortcake.another.snowfall.TigerSkullBuffed_title", "Caveira de Tigre");
            table.AddEntry("shortcake.another.snowfall.FrenzyWrenchBuffed_title", "Chave Frenética");
            table.AddEntry("shortcake.another.snowfall.BroadSword_title", "Espada Larga");
            table.AddEntry("shortcake.another.snowfall.BroadSword_flavour", "Uma arma refeita a partir de uma Espada Cega");
            table.AddEntry("shortcake.another.snowfall.ShroomBranch_title", "Galho de Fungo");
            table.AddEntry("shortcake.another.snowfall.SpiceStuff_title", "Cajado Picante");
            table.AddEntry("shortcake.another.snowfall.BerryStuff_title", "Cajado Baga");
            table.AddEntry("shortcake.another.snowfall.BerryStuff_text", "<keyword=cleanse>");
            table.AddEntry("shortcake.another.snowfall.FrostSword_title", "Espada Congelada");
            table.AddEntry("shortcake.another.snowfall.FrostSword2_title", "Espada Congelada");
            table.AddEntry("shortcake.another.snowfall.GoatSpear_title", "Lança Cabra");
            table.AddEntry("shortcake.another.snowfall.GoatSpear2_title", "Lança Cabra");
            table.AddEntry("shortcake.another.snowfall.FrostWater_title", "Água Congelada");
            table.AddEntry("shortcake.another.snowfall.FrostWater_text", "Reduza <keyword=attack> em <{a}>");
            table.AddEntry("shortcake.another.snowfall.IceDiceBuffedLumin_title", "Dado Gélido");
            table.AddEntry("shortcake.another.snowfall.SunburstTootooBuffed_title", "Triângulo Solar");
            table.AddEntry("shortcake.another.snowfall.Longbow_title", "Arco Longo");
            table.AddEntry("shortcake.another.snowfall.Arrow_title", "Flecha");
            table.AddEntry("shortcake.another.snowfall.WideSpear_title", "Lança Longa");
            table.AddEntry("shortcake.another.snowfall.SharpSpear_title", "Lança Afiada");
            table.AddEntry("shortcake.another.snowfall.Cudgel_title", "Porrete");
            table.AddEntry("shortcake.another.snowfall.FrostTrident_title", "Tridente Congelado");
            table.AddEntry("shortcake.another.snowfall.Takoyaki_title", "Takoyaki de Dragão");
            table.AddEntry("shortcake.another.snowfall.Catalyst_title", "Água de Sombritude");
            table.AddEntry("shortcake.another.snowfall.FluffyGlove_title", "Luva Fofa");
            table.AddEntry("shortcake.another.snowfall.Lemonade_title", "Limonada Solar");
            table.AddEntry("shortcake.another.snowfall.PinkberryCake_title", "Bolo de Baga Rosa");
            table.AddEntry("shortcake.another.snowfall.PinkberryCake_text", "<keyword=cleanse>");
            table.AddEntry("shortcake.another.snowfall.SnowShavedIce_title", "Raspadinha");
            table.AddEntry("shortcake.another.snowfall.FrozenDrink_title", "Bomba de Gelo");
            table.AddEntry("shortcake.another.snowfall.PinkberryPudding_title", "Pudim de Baga Rosa");
            table.AddEntry("shortcake.another.snowfall.HazeCan_title", "Bomba de Fumaça");
            table.AddEntry("shortcake.another.snowfall.SnowDrink_title", "Bebida de Neve");
            table.AddEntry("shortcake.another.snowfall.SnowBlade_title", "Martelos Gelados");
            table.AddEntry("shortcake.another.snowfall.InkBarrel_title", "Barril de Tinta");
            table.AddEntry("shortcake.another.snowfall.BattlePotion_title", "Refrigerate de Baga Quente");
            table.AddEntry("shortcake.another.snowfall.BattlePotion_text", "Diminui a vida <keyword=health> de um aliado pela metade");
            table.AddEntry("shortcake.another.snowfall.BootlegPotion_title", "Máscara Pirata");
            table.AddEntry("shortcake.another.snowfall.SunBag_title", "Kit Mágico");
            table.AddEntry("shortcake.another.snowfall.CottonCandy_title", "Algodão-doce");
            table.AddEntry("shortcake.another.snowfall.Ramune_title", "Biscoitos Gnômicos");
            table.AddEntry("shortcake.another.snowfall.InkBottle_title", "Garrafa de Tinta");
            table.AddEntry("shortcake.another.snowfall.BagOfNuts_title", "Sacola de Nozes");
            table.AddEntry("shortcake.another.snowfall.BranchOfNuts_title", "Galho de Nozes");
            table.AddEntry("shortcake.another.snowfall.FrenzySword_title", "Shuriken");
            table.AddEntry("shortcake.another.snowfall.LavaGlass_title", "Ampulheta Derretida");
            table.AddEntry("shortcake.another.snowfall.RoseHoney_title", "Geleia de Baga Rosa");
            table.AddEntry("shortcake.another.snowfall.PoisonShooter_title", "Buquê de Cogumelos");
            table.AddEntry("shortcake.another.snowfall.PoisonBucket_title", "Balde de Veneno");
            table.AddEntry("shortcake.another.snowfall.Shortcake_title", "Cupcake Zoomlin");
            table.AddEntry("shortcake.another.snowfall.StarBell_title", "Sino Estelar");
            table.AddEntry("shortcake.another.snowfall.StoneSword_title", "Porrete de Pedra");
            table.AddEntry("shortcake.another.snowfall.StoneShield_title", "Peitoral Casca-pedra");
            table.AddEntry("shortcake.another.snowfall.CursedSword_title", "Amuleto Solar");
            table.AddEntry("shortcake.another.snowfall.HeatSword_title", "Cimitarra Picante");
            table.AddEntry("shortcake.another.snowfall.HeatSword2_title", "Cimitarra Picante");
            table.AddEntry("shortcake.another.snowfall.WildHorn_title", "Feno de Porco");
            table.AddEntry("shortcake.another.snowfall.DemonHammer_title", "Martelo Demoníaco");
            table.AddEntry("shortcake.another.snowfall.Jewelberry_title", "Bomba Baga");
            table.AddEntry("shortcake.another.snowfall.PinkberryPot_title", "Frasco de Baga Rosa");
            table.AddEntry("shortcake.another.snowfall.SnowCrossbow_title", "Besta de Neve");
            table.AddEntry("shortcake.another.snowfall.SpiceStew_title", "Sopa Picante");
            table.AddEntry("shortcake.another.snowfall.SlimyStick_title", "Graveto Pegajoso");
            table.AddEntry("shortcake.another.snowfall.WoodenSword_title", "Espada de Madeira");
            table.AddEntry("shortcake.another.snowfall.WoodenSword_text", "Mate alvos <Geringonça>");
            table.AddEntry("shortcake.another.snowfall.ToxicCake_title", "Bolo Tóxico");
            table.AddEntry("shortcake.another.snowfall.ToxicCake_text", "Reduz <keyword=attack> em <{a}>");
            table.AddEntry("shortcake.another.snowfall.CleansePot_title", "Frasco da Limpeza");
            table.AddEntry("shortcake.another.snowfall.CrystalStar_title", "Estrela de Cristal");
            table.AddEntry("shortcake.another.snowfall.LuminShard_title", "Fragmento de Luminância");
            table.AddEntry("shortcake.another.snowfall.Demonzooka_title", "Demonzooka");
            table.AddEntry("shortcake.another.snowfall.PepperKnife_title", "Faca Pimenta");
            table.AddEntry("shortcake.another.snowfall.ForgingStoveBuffed_text", "Dobre o <keyword=attack> de um <Item>");
            table.AddEntry("shortcake.another.snowfall.SunBanjo_title", "Banjo Solar");
            table.AddEntry("shortcake.another.snowfall.IceLanternAlly_title", "Lanterna  de Gelo");
            table.AddEntry("shortcake.another.snowfall.IceLanternLuminAlly_title", "Lanterna  de Gelo");
            table.AddEntry("shortcake.another.snowfall.IceForgeAlly_title", "Forja de Gelo");
            table.AddEntry("shortcake.another.snowfall.IceForgeAlly_text", "Enquanto ativo(a), adicione <+{a}><keyword=attack> a todos aliados e <-{a}><keyword=attack> a todos inimigos");
            table.AddEntry("shortcake.another.snowfall.MokoHeadAlly_title", "Cabeça de Moko");
            table.AddEntry("shortcake.another.snowfall.OctobomAlly_title", "Octobom");
            table.AddEntry("shortcake.another.snowfall.OctobomAllyDebuffed_title", "Octobom");
            table.AddEntry("shortcake.another.snowfall.SpikeWallAlly_title", "Muro de Espinhos");
            table.AddEntry("shortcake.another.snowfall.BiteboxScrap_title", "Mordiscaixa");
            table.AddEntry("shortcake.another.snowfall.Catapult_title", "Catapulta");
            table.AddEntry("shortcake.another.snowfall.LavaLantern_title", "Lanterna de Lava");
            table.AddEntry("shortcake.another.snowfall.HazeBucket_title", "Tanque de Fumaça");
            table.AddEntry("shortcake.another.snowfall.FrostCake_title", "Espelho Congelado");
            table.AddEntry("shortcake.another.snowfall.Bonfire_title", "Fogueira");
            table.AddEntry("shortcake.another.snowfall.FrostMimikAlly_title", "Mimiko Congelado");
            table.AddEntry("shortcake.another.snowfall.FogCurse_title", "Névoa");
            table.AddEntry("shortcake.another.snowfall.BigSnowballCurse_title", "Tempestade de Neve");
            table.AddEntry("shortcake.another.snowfall.BigShroomCurse_title", "Dente de Fungo");
            table.AddEntry("shortcake.another.snowfall.FrostCrystalCurse_title", "Cristal Congelado");
            table.AddEntry("shortcake.another.snowfall.TimeBombCurse_title", "BINK Quebrado");
            table.AddEntry("shortcake.another.snowfall.IciclesCurse_title", "Brinícula");
            table.AddEntry("shortcake.another.snowfall.StoneTabletCurse_title", "Tábua de Pedra");
            table.AddEntry("shortcake.another.snowfall.StoneTabletCurse2_title", "Tábua de Pedra");
            table.AddEntry("shortcake.another.snowfall.StoneTabletCurse3_title", "Tábua de Pedra");
            table.AddEntry("shortcake.another.snowfall.BlessingLuminRing_modifier_title", "Sino Lumin");
            table.AddEntry("shortcake.another.snowfall.BlessingLuminRing_modifier_desc", "Ganhe <Amuleto de Luminância>\r\nGanhe uma <maldição> aleatória");
            table.AddEntry("shortcake.another.snowfall.BlessingBlockCharms_modifier_title", "Sino Coração Congelado");
            table.AddEntry("shortcake.another.snowfall.BlessingBlockCharms_modifier_desc", "Adiciona <2><keyword=block> e reduz <keyword=health> do lider para <1>");
            table.AddEntry("shortcake.another.snowfall.BlessingRitualCharm_modifier_title", "Sino Espada Ritual");
            table.AddEntry("shortcake.another.snowfall.BlessingRitualCharm_modifier_desc", "Ganhe <Amuleto Ritual>");
            table.AddEntry("shortcake.another.snowfall.BlessingBlingSackCharm_modifier_title", "Sino Saco de Bling");
            table.AddEntry("shortcake.another.snowfall.BlessingBlingSackCharm_modifier_desc", "Ganhe <100><keyword=blings>");
            table.AddEntry("shortcake.another.snowfall.BlessingJustFrenzyCharm_modifier_title", "Sino Frenético");
            table.AddEntry("shortcake.another.snowfall.BlessingJustFrenzyCharm_modifier_desc", "Ganhe <Amuleto Apenas Frenesi>\r\nGanhe uma <maldição> aleatória");
            table.AddEntry("shortcake.another.snowfall.BrokenBell2_modifier_desc", "Compre <3> cartas adicionais se você tocar o <Sino de Recompra> quando ele estiver carregado\r\nGanhe <duas> <maldições> aleatória");
            table.AddEntry("shortcake.another.snowfall.Blessing2BattleCharm_modifier_title", "Sino Glacinata");
            table.AddEntry("shortcake.another.snowfall.Blessing2BattleCharm_modifier_desc", "Ganhe <2> <Amuletos de Batalha>");
            table.AddEntry("shortcake.another.snowfall.BlessingSunCharm_modifier_title", "Sino da Geada");
            table.AddEntry("shortcake.another.snowfall.BlessingSunCharm_modifier_desc", "Ganhe <Amuleto do Sol>");
            table.AddEntry("shortcake.another.snowfall.BlessingDreadBell_modifier_title", "Sino do Remorso");
            table.AddEntry("shortcake.another.snowfall.BlessingDreadBell_modifier_desc", "Todos <Companheiros> têm um <Amuleto> aleatório\r\nGanhe uma <maldição> aleatória");
            table.AddEntry("shortcake.another.snowfall.BlessingHordeBell_modifier_title", "Sino das Hordas");
            table.AddEntry("shortcake.another.snowfall.BlessingHordeBell_modifier_desc", "Todos <Companheiros> têm <Noomlin>");
            table.AddEntry("shortcake.another.snowfall.BlessingLeaderCharms_modifier_title", "Sino Titã");
            table.AddEntry("shortcake.another.snowfall.BlessingLeaderCharms_modifier_desc", "Adicione <2> <Amuletos> aleatórios ao líder");
            table.AddEntry("shortcake.another.snowfall.BlessingGobbler_modifier_title", "Sino Comilão");
            table.AddEntry("shortcake.another.snowfall.BlessingGobbler_modifier_desc", "Ganhe um <Comilão>");
            table.AddEntry("shortcake.another.snowfall.StormLuminBell_modifier_title", "Sino Lumin");
            table.AddEntry("shortcake.another.snowfall.StormLuminBell_modifier_desc", "Um único inimigo ganhará <Lumin> em cada batalha após o primeiro chefão");
            table.AddEntry("shortcake.another.snowfall.StormFrenzyBell_modifier_title", "Sino da Frenesi");
            table.AddEntry("shortcake.another.snowfall.StormFrenzyBell_modifier_desc", "Um único inimigo ganhará <x1><keyword=frenzy> em cada batalha das <Terras Congeladas>");
            table.AddEntry("shortcake.another.snowfall.StormFrozenHeartBell_modifier_title", "Sino Coração Congelado");
            table.AddEntry("shortcake.another.snowfall.StormFrozenHeartBell_modifier_desc", "Alguns inimigos em batalhas de chefão serão melhorados com <Amuletos de Bloqueio>");
            table.AddEntry("shortcake.another.snowfall.StormGoatBell_modifier_desc", "Seu líder perde <3><keyword=health>");
            table.AddEntry("shortcake.another.snowfall.StormFogBell_modifier_title", "Sino da Neblina");
            table.AddEntry("shortcake.another.snowfall.StormFogBell_modifier_desc", "Ganhe uma <Maldição> após cada Batalha de Chefão");
            table.AddEntry("shortcake.another.snowfall.BlessingCrown2_modifier_title", "Sino Solar dos Reis");
            table.AddEntry("shortcake.another.snowfall.BlessingCrown2_modifier_desc", "Ganhe uma <sprite name=crown>");
            table.AddEntry("shortcake.another.snowfall.shortcake.shaderitual_text", "O Ritual Macabro");
            table.AddEntry("shortcake.another.snowfall.shortcake.monchsbreakfast_text", "Café-da-Manhã do Monch");
            table.AddEntry("shortcake.another.snowfall.shortcake.pethouse_text", "A Casa dos Pets");
            table.AddEntry("shortcake.another.snowfall.shortcake.shroomforest_text", "A Floresta Cogumelo");
            table.AddEntry("shortcake.another.snowfall.shortcake.berriesforest_text", "O Bando de Bagas");
            table.AddEntry("shortcake.another.snowfall.shortcake.snowland_text", "Wallop");
            table.AddEntry("shortcake.another.snowfall.shortcake.blazingbonfire_text", "Nova");
            table.AddEntry("shortcake.another.snowfall.shortcake.spicevillage_text", "A Vila Picante");
            table.AddEntry("shortcake.another.snowfall.shortcake.foxeesdebris_text", "O Rapozee");
            table.AddEntry("shortcake.another.snowfall.shortcake.bomblabo_text", "O Clube das Geringonças");
            table.AddEntry("shortcake.another.snowfall.shortcake.limestonecave_text", "O Poço dos Dentes");
            table.AddEntry("shortcake.another.snowfall.shortcake.shellforest_text", "Chompom");
            table.AddEntry("shortcake.another.snowfall.shortcake.breakdownfactory_text", "Agulha");
            table.AddEntry("shortcake.another.snowfall.shortcake.soulgrave_text", "A Tumba Ardente");
            table.AddEntry("shortcake.another.snowfall.shortcake.monchsdinner_text", "Jantar do Monch");
            table.AddEntry("shortcake.another.snowfall.shortcake.falsefinal_text", "Torradeira");
            table.AddEntry("shortcake.another.snowfall.shortcake.truefinal_text", "Batalha");
        }
        ...
        private void SetUITextLocalizations()
        {
            ...
            table.AddEntry("cobalt.wildfrost.bloons.TribeTitle", "Os Macacos");
            table.AddEntry("cobalt.wildfrost.bloons.TribeDesc", "De uma terra muito distante, um gripo de macacos prontos para o combate\r\nchegaram para ajudar! Eles são guiados por um herói poderoso, e parecem usar todo tipo de truque existente.\r\n\r\nMesmo que eles não foquem em nenhum estilo, a grande variedade de opções garante que você encontre uma sinergia de maneiras inesperadas.");
        }
        ...
        private void SetUpgradesLocalizations()
        {
            ...
            table.AddEntry("shortcake.another.snowfall.JustFrenzyCharm_title", "Amuleto Apenas Frenesi");
            table.AddEntry("shortcake.another.snowfall.JustFrenzyCharm_text", "Adicione <x1><keyword=frenzy>");
            table.AddEntry("shortcake.another.snowfall.RitualCharm_title", "Amuleto Ritual");
            table.AddEntry("shortcake.another.snowfall.RitualCharm_text", "Quando um aliado é morto, ganhe seu <keyword=attack>");
            table.AddEntry("shortcake.another.snowfall.DrawCharm_title", "Amuleto da Compra");
            table.AddEntry("shortcake.another.snowfall.DrawCharm_text", "Ganhe <keyword=draw 1>");
            table.AddEntry("shortcake.another.snowfall.LuminiceCharm_title", "Amuleto de Luminância");
            table.AddEntry("shortcake.another.snowfall.LuminiceCharm_text", "Dobre os efeitos");
            table.AddEntry("shortcake.another.snowfall.BlueCharmEnemy_title", "Amuleto Coração Congelado (Inimigo)");
            table.AddEntry("shortcake.another.snowfall.BalanceCharmEnemy_title", "Amuleto do Equilíbrio (Inimigo)");
            table.AddEntry("shortcake.another.snowfall.LuminiceCharmForNeedle_title", "Amuleto de Luminância (Agulha)");
            table.AddEntry("shortcake.another.snowfall.LuminiceCharmForNeedle_text", "Invoca <Tábua de Pedra> com <keyword=lumin> agora");
            table.AddEntry("shortcake.another.snowfall.CrystalShardCharm_title", "Amuleto Fragmento de Cristal");
            table.AddEntry("shortcake.another.snowfall.CrystalShardCharm_text", "Ganhe <1><keyword=block> em abates\r\n<-1><keyword=attack>");
            table.AddEntry("shortcake.another.snowfall.CrystalStarCharm_title", "Amuleto Estrela de Cristal");
            table.AddEntry("shortcake.another.snowfall.CrystalStarCharm_text", "Quando consumido(a), aplique <1><keyword=block> a um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.OrangeCharm_title", "Amuleto Laranja");
            table.AddEntry("shortcake.another.snowfall.OrangeCharm_text", "Remove <keyword=counter>\r\nAtive quando atingido");
            table.AddEntry("shortcake.another.snowfall.BarrierCharm_title", "Amuleto Barreira");
            table.AddEntry("shortcake.another.snowfall.BarrierCharm_text", "Quando posto(a), ganhe <1><keyword=block>\r\nreduza <keyword=health> para <1>");
            table.AddEntry("shortcake.another.snowfall.GoldenCharm_title", "Amuleto Dourado");
            table.AddEntry("shortcake.another.snowfall.GoldenCharm_text", "Remove <keyword=barrage>\r\nAtinge todos inimigos");
            table.AddEntry("shortcake.another.snowfall.ReuseCharm_title", "Amuleto do Reuso");
            table.AddEntry("shortcake.another.snowfall.ReuseCharm_text", "Remove <keyword=consume>\r\nGanhe <keyword=shortcake.another.snowfall.limit> <2>");
            table.AddEntry("shortcake.another.snowfall.SnowFlowerCharm_title", "Amuleto Flor de Gelo");
            table.AddEntry("shortcake.another.snowfall.SnowFlowerCharm_text", "Quando atingido(a), aplique <1><keyword=snow> ao atacante\r\nComece com <2><keyword=snow>");
            table.AddEntry("CardUpgradeSnowImmune_text", "Quando receber <keyword=snow>, ganhe <keyword=attack> equivalente no lugar");
            table.AddEntry("CardUpgradeDraw_text", "Ganhe <keyword=draw 1>");
            table.AddEntry("CardUpgradeTrash_text", "Ganhe <keyword=trash 1>\r\nAdicione <x1><keyword=frenzy>");
            table.AddEntry("CardUpgradeHook_text", "Ganhe <keyword=pull 2> e <keyword=longshot>\r\n<+2><keyword=attack>");
            table.AddEntry("CardUpgradeCrush_text", "Ganhe <keyword=recycle 1>\r\nRemove <keyword=consume>");
            table.AddEntry("CardUpgradeCloudberry_text", "<+3><keyword=health>\r\nNão ocupa um espaço de amuleto");
            table.AddEntry("CardUpgradeShellOnKill_text", "Quando atingido(a), aplique <1><keyword=shell> ao aliado atrás");
            table.AddEntry("CardUpgradeAttackIncreaseCounter_text", "<+3><keyword=attack>\r\nOcupa <2> espaços de amuleto");
            table.AddEntry("CardUpgradeRemoveCharmLimit_text", "Quando ganhar um amuleto, ganhe <+1><keyword=attack> ou <+1><keyword=health>\r\nRemova o limite de amuletos\r\nNão ocupa um espaço de amuleto");
        }
        ...
        private void SetCardTextLocalizations()
        {
            ...
            table.AddEntry("Trigger When Teeth Damage_text", "Ativa quando dano por <keyword=teeth> é tomado");
            ...
            table.AddEntry("On Kill Trigger Redraw Bell_text", "Ativa o <Sino de Recompra> em abates");
            ...
            table.AddEntry("vibeneutral.wildfrost.hollowfrost.Hit Redraw Bell_text", "Ativa o <Sino de Recompra>");
            ...
            table.AddEntry("On Card Played Trigger Target_text", "Ativa o alvo");
            ...
            table.AddEntry("Wildfrost.Jacorb.Snowfall.TriggerAgainstSnowedEnemies_text", "Ativa contra inimigos com <keyword=snow>");
            ...
            table.AddEntry("cobalt.wildfrost.bloons.Uncharmable_text", "<keyword=cobalt.wildfrost.bloons.uncharmable>");
            table.AddEntry("cobalt.wildfrost.bloons.When Deployed Summon Bramble_text", "Quando posto(a), invoque {0}");
            table.AddEntry("cobalt.wildfrost.bloons.When Deployed Summon greenball_text", "Quando posto(a), invoque {0}");
            table.AddEntry("cobalt.wildfrost.bloons.When Deployed Summon bud_text", "Quando posto(a), invoque {0}");
            table.AddEntry("cobalt.wildfrost.bloons.When Deployed Summon blud_text", "Quando posto(a), invoque {0}");
            table.AddEntry("cobalt.wildfrost.bloons.Summon marine_text", "Invoque {0}");
            table.AddEntry("cobalt.wildfrost.bloons.Summon sentry_text", "Invoque {0}");
            table.AddEntry("cobalt.wildfrost.bloons.Summon xxxl_text", "Invoque {0}");
            table.AddEntry("cobalt.wildfrost.bloons.Summon spikes_text", "Invoque {0}");
            table.AddEntry("cobalt.wildfrost.bloons.Summon pineapple_text", "Invoque {0}");
            table.AddEntry("cobalt.wildfrost.bloons.Summon bombspike_text", "Invoque {0}");
            table.AddEntry("cobalt.wildfrost.bloons.When Played Summon Elemental Sentry_text", "Adicione uma sentinela elemental aleatória a sua mão");
            table.AddEntry("cobalt.wildfrost.bloons.Summon Enemy Totem_text", "Invoque <card=cobalt.wildfrost.bloons.bigtotem> no lado inimigo");
            table.AddEntry("cobalt.wildfrost.bloons.When Enemy Is Killed Summon ubloon_text", "Quando um inimigo é morto, invoque {0}");
            table.AddEntry("cobalt.wildfrost.bloons.On Turn Summon shell1_text", "Adicione {0} a sua mão");
            table.AddEntry("cobalt.wildfrost.bloons.On Turn Summon shell2_text", "Adicione {0} a sua mão");
            table.AddEntry("cobalt.wildfrost.bloons.On Turn Summon missile_text", "Adicione {0} a sua mão");
            table.AddEntry("cobalt.wildfrost.bloons.On Turn Summon bomba_text", "Adicione {0} a sua mão");
            table.AddEntry("cobalt.wildfrost.bloons.On Turn Summon harpoon1_text", "Adicione {0} a sua mão");
            table.AddEntry("cobalt.wildfrost.bloons.On Turn Apply Block To RandomAlly_text", "Aplique {0} a um aliado aleatório");
            table.AddEntry("cobalt.wildfrost.bloons.On Turn Apply Demonize To Enemies_text", "Aplique <{a}><keyword=demonize> a todos inimigos");
            table.AddEntry("cobalt.wildfrost.bloons.Damage Equal To Highest Enemy Attack_text", "Dê dano igual ao maior <keyword=attack> inimigo");
            table.AddEntry("cobalt.wildfrost.bloons.On Card Played Apply Frost To Allies_text", "Aplique <{a}><keyword=frost> a todos aliados");
            table.AddEntry("cobalt.wildfrost.bloons.On Turn Apply Haze To RandomEnemy_text", "Aplique {0} a um inimigo aleatório");
            table.AddEntry("cobalt.wildfrost.bloons.Instant count up_text", "Aumente o <keyword=counter> em <{a}>");
            table.AddEntry("cobalt.wildfrost.bloons.Temp Multihit for cards in hand_text", "Ganhe <keyword=frenzy> para cada carta na mão");
            table.AddEntry("cobalt.wildfrost.bloons.Temp attack for allies_text", "Antes de atacar, ganhe <+{a}><keyword=attack> para cada aliado");
            table.AddEntry("cobalt.wildfrost.bloons.boost self_text", "Melhore os efeitos desta carta");
            table.AddEntry("cobalt.wildfrost.bloons.boost other_text", "Melhore os efeitos do alvo");
            table.AddEntry("cobalt.wildfrost.bloons.Increase Attack to all_text", "Aumente <keyword=attack> de todos aliados em <{a}>");
            table.AddEntry("shortcake.another.snowfall.ImmuneToInk_text", "<keyword=shortcake.another.snowfall.enemyitem>");
            table.AddEntry("shortcake.another.snowfall.Convert Ink To Frost_text", "Quando receber <keyword=null>, ganhe <keyword=frost> no lugar");
            table.AddEntry("shortcake.another.snowfall.ImmuneToBlock_text", "Não pode receber <keyword=scrap>/<keyword=block>/<keyword=shell>");
            table.AddEntry("shortcake.another.snowfall.ImmuneToBuff_text", "Não pode receber buffs");
            table.AddEntry("shortcake.another.snowfall.ImmuneToDebuff_text", "Quando debuffedo(a), largue <keyword=blings> equivalentes no lugar");
            table.AddEntry("shortcake.another.snowfall.ImmuneToStatuses_text", "Não pode ganhar status");
            table.AddEntry("shortcake.another.snowfall.When Scrap Lost Drop Gold_text", "Quando perder <keyword=scrap>, largue <{a}><keyword=blings>");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Drop Gold_text", "Quando destruído(a), largue <{a}><keyword=blings>");
            table.AddEntry("shortcake.another.snowfall.When Drawn Gain Frenzy_text", "Quando comprado(a), ganhe <x{a}><keyword=frenzy>");
            table.AddEntry("shortcake.another.snowfall.When Drawn Gain Attack_text", "Quando comprado(a), ganhe <+{a}><keyword=attack>");
            table.AddEntry("shortcake.another.snowfall.When Drawn Increase Effects_text", "Quando comprado(a), melhore os efeitos em {a}");
            table.AddEntry("shortcake.another.snowfall.When Ally is Hit Apply Attack To Self_text", "Ganhe <+{a}><keyword=attack> quando um aliado é atingido");
            table.AddEntry("shortcake.another.snowfall.On Kill Apply Frenzy To Self_text", "Ganhe <x{a}><keyword=frenzy> em abates");
            table.AddEntry("shortcake.another.snowfall.On Turn Apply Frost To Enemies_text", "Aplique <{a}><keyword=frost> a todos inimigos");
            table.AddEntry("shortcake.another.snowfall.When Health Lost Apply Equal Attack To Self_text", "Quando perder <keyword=health>, ganhe <keyword=attack> equivalente");
            table.AddEntry("shortcake.another.snowfall.When Item Destroyed, Trigger To Self_text", "Ativa quando um <item> é destruído");
            table.AddEntry("shortcake.another.snowfall.While Active Reduce Attack To Items In Hand_text", "Enquanto ativo(a), adicione <-{a}><keyword=attack> aos <Items> na sua mão");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Apply Ink To Enemies_text", "Quando destruído(a), aplique <{a}><keyword=null> a todos inimigos");
            table.AddEntry("shortcake.another.snowfall.Pre Turn Destroy All Junk In Hand & Gain Attack For Each_text", "Antes de atacar, destrua todos os <card=Junk> na mão e ganhe <+{a}><keyword=attack> para cada");
            table.AddEntry("shortcake.another.snowfall.Pre Turn Destroy All Junk In Hand & Gain Attack And Health For Each_text", "Antes de atacar, destrua todos os <card=Junk> na mão e ganhe <+{a}><keyword=attack>/<+{a}><keyword=health> para cada");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Summon WeakChikani_text", "Quando destruído(a), invoque <card=shortcake.another.snowfall.WeakChikani>");
            table.AddEntry("shortcake.another.snowfall.Summon WeakChikani_text", "Invoque <card=shortcake.another.snowfall.WeakChikani>");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Summon WeakChikasan_text", "Quando destruído(a), invoque <card=shortcake.another.snowfall.WeakChikasan>");
            table.AddEntry("shortcake.another.snowfall.Summon WeakChikasan_text", "Invoque <card=shortcake.another.snowfall.WeakChikasan>");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Summon StrongChikani_text", "Quando destruído(a), invoque <card=shortcake.another.snowfall.StrongChikani>");
            table.AddEntry("shortcake.another.snowfall.Summon StrongChikani_text", "Invoque <card=shortcake.another.snowfall.StrongChikani>");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Summon StrongChikasan_text", "Quando destruído(a), invoque <card=shortcake.another.snowfall.StrongChikasan>");
            table.AddEntry("shortcake.another.snowfall.Summon StrongChikasan_text", "Invoque <card=shortcake.another.snowfall.StrongChikasan>");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Summon StrongChikashi_text", "Quando destruído(a), invoque <card=shortcake.another.snowfall.StrongChikashi>");
            table.AddEntry("shortcake.another.snowfall.Summon StrongChikashi_text", "Invoque <card=shortcake.another.snowfall.StrongChikashi>");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Summon StrongChikagoru_text", "Quando destruído(a), invoque <card=shortcake.another.snowfall.StrongChikagoru>");
            table.AddEntry("shortcake.another.snowfall.Summon StrongChikagoru_text", "Invoque <card=shortcake.another.snowfall.StrongChikagoru>");
            table.AddEntry("shortcake.another.snowfall.On Turn Eat Random Ally (Health & Attack)_text", "Devore <Chikichi>ou um aliado invocado aleatório, absorvendo seu <keyword=attack> e <keyword=health>");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Apply Overload To Enemies_text", "Quando destruído(a), aplique <{a}><keyword=overload> a todos inimigos");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Apply Overload To FrontEnemy_text", "Quando destruído(a), aplique <{a}><keyword=overload> ao inimigo da frente");
            table.AddEntry("shortcake.another.snowfall.Summon Beepop2_text", "Invoque <card=shortcake.another.snowfall.BeepopEnemy>");
            table.AddEntry("shortcake.another.snowfall.On Hit Equal Frost To Target_text", "Aplique <keyword=frost> equivalente ao dano dado");
            table.AddEntry("shortcake.another.snowfall.When Spice Applied To Self Gain Equal Attack_text", "Quando receber <keyword=spice>, ganhe <keyword=attack> equivalente");
            table.AddEntry("shortcake.another.snowfall.While Active Frenzy To FrontAlly_text", "Enquanto ativo(a), adicione <x{a}><keyword=frenzy> ao aliado à frente");
            table.AddEntry("shortcake.another.snowfall.On Card Played Apply Demonize To EnemiesInRow_text", "Aplique <{a}><keyword=demonize> aos inimigos na faixa");
            table.AddEntry("shortcake.another.snowfall.When Shell Applied To Self Gain Equal Teeth_text", "Quando receber <keyword=shell>, ganhe <keyword=teeth> equivalente");
            table.AddEntry("shortcake.another.snowfall.When Hit Gain Frenzy To Self (No Ping)_text", "Quando atingido(a), ganhe <x{a}><keyword=frenzy>");
            table.AddEntry("shortcake.another.snowfall.On Turn Add Health To Allies_text", "Adicione <+{a}><keyword=health> a todos aliados");
            table.AddEntry("shortcake.another.snowfall.While Active Increase Effect To AlliesBehind_text", "Enquanto ativo(a), melhore os efeitos do aliado atrás em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Boost To EnemiesInRow_text", "Melhore os efeitos de inimigos na faixa em {a}");
            table.AddEntry("shortcake.another.snowfall.On Card Played Boost To RandomEnemy Without Resist Ink_text", "Melhore os efeitos de um inimigo aleatório sem <Imunidade a Tinta> em {a}");
            table.AddEntry("shortcake.another.snowfall.While Active Reduce Effect To Enemies_text", "Enquanto ativo(a), reduza os efeitos de todos inimigos em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Hit Equal Shell To Self_text", "Ganhe <keyword=shell> equivalente ao dano dado");
            table.AddEntry("shortcake.another.snowfall.When Hit Apply Frost To Attacker_text", "Quando atingido(a), aplique <{a}><keyword=frost> ao atacante");
            table.AddEntry("shortcake.another.snowfall.On Hit Equal Teeth To Self_text", "Ganhe <keyword=teeth> equivalente ao dano dado");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Apply Damage To Enemies_text", "Quando destruído(a), dê <{a}> de dano a todos inimigos");
            table.AddEntry("shortcake.another.snowfall.When Card Destroyed, Apply Shell To AlliesInRow_text", "Quando uma carta dor destruída, aplique <{a}><keyword=shell> ao aliado à frente");
            table.AddEntry("shortcake.another.snowfall.When Enemy Is Killed Apply Spice To AlliesInRow_text", "Quando um inimigo for morto, aplique <{a}><keyword=spice> aos aliados na faixa");
            table.AddEntry("shortcake.another.snowfall.Add Health To Summon_text", "Aumente a <keyword=health> da invocação em <{a}>");
            table.AddEntry("shortcake.another.snowfall.When Deployed Copy Effects Of RandomAlly_text", "Quando posto(a), copie os efeitos de um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.When Hit Apply Equal Frost To Attacker_text", "Quando atingido(a), aplique <keyword=frost> equivalente à <keyword=health> perdida ao atacante");
            table.AddEntry("shortcake.another.snowfall.Increase Effects With Text_text", "Melhore os efeitos do alvo em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Turn Add Health To AlliesInRow_text", "Adicione <+{a}><keyword=health> aos aliados na faixa");
            table.AddEntry("shortcake.another.snowfall.When Ally Is Killed Increase Health To Allies_text", "Adicione <+{a}><keyword=health> aos aliados quando um aliado morrer");
            table.AddEntry("shortcake.another.snowfall.On Card Played Apply Haze To RandomEnemy_text", "Aplique <{a}><keyword=haze> a um inimigo aleatório");
            table.AddEntry("shortcake.another.snowfall.Pre Turn Destroy All Junk In Hand & Gain Spice For Each_text", "Antes de atacar, destrua todos <card=Junk> na mão e ganhe <{a}><keyword=spice> para cada");
            table.AddEntry("shortcake.another.snowfall.Pre Turn Destroy All Items In Hand & Gain Spice For Each_text", "Antes de atacar, destrua todos <itens> na mão e ganhe <{a}><keyword=spice> para cada");
            table.AddEntry("shortcake.another.snowfall.Hit Redraw Bell_text", "Ative o <Sino de Recompra>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Hit Redraw Bell_text", "Ative o <Sino de Recompra>");
            table.AddEntry("shortcake.another.snowfall.Instant Gain Zoomlin (To Card In Hand)_text", "Adicione <keyword=zoomlin> a uma carta na sua mão");
            table.AddEntry("shortcake.another.snowfall.When Drawn Destroy Self_text", "Quando comprado(a), se destrua");
            table.AddEntry("shortcake.another.snowfall.When Drawn Apply Snow To Allies2_text", "Quando comprado(a), aplique <{a}><keyword=snow> a todos aliados");
            table.AddEntry("shortcake.another.snowfall.When Drawn Apply Shroom To Allies_text", "Quando comprado(a), aplique <{a}><keyword=shroom> a todos aliados");
            table.AddEntry("shortcake.another.snowfall.When Drawn Apply Frost To Allies_text", "Quando comprado(a), aplique <{a}><keyword=frost> a todos aliados");
            table.AddEntry("shortcake.another.snowfall.When Drawn Apply Frost To Hand_text", "Quando comprado(a), aplique <{a}><keyword=frost> a todos <itens> na sua mão");
            table.AddEntry("shortcake.another.snowfall.On Card Played Apply Spice To Hand_text", "Aplique <{a}><keyword=spice> a todas cartas na sua mão");
            table.AddEntry("shortcake.another.snowfall.When Drawn Apply Explode To RandomEnemy_text", "Quando comprado(a), aplique <keyword=explode {a}> a um inimigo aleatório");
            table.AddEntry("shortcake.another.snowfall.When Drawn Apply Block To RandomEnemy_text", "Quando comprado(a), aplique <{a}><keyword=block> a um inimigo aleatório");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon Icicles To DiscardPile_text", "Adicione <{a}> <card=shortcake.another.snowfall.IciclesCurse> a sua pilha de descarte");
            table.AddEntry("shortcake.another.snowfall.Summon Icicles_text", "Invoque <card=shortcake.another.snowfall.IciclesCurse>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon Fog To DrawPile_text", "Adicione <{a}> <card=shortcake.another.snowfall.FogCurse> ao topo de sua pilha de compra");
            table.AddEntry("shortcake.another.snowfall.Summon Fog_text", "Invoque <card=shortcake.another.snowfall.FogCurse>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon Fog To DiscardPile_text", "Adicione <{a}> <card=shortcake.another.snowfall.FogCurse> a sua pilha de descarte");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon BigSnowball To DiscardPile_text", "Adicione <{a}> <card=shortcake.another.snowfall.BigSnowballCurse> a sua pilha de descarte");
            table.AddEntry("shortcake.another.snowfall.Summon BigSnowball_text", "Invoque <card=shortcake.another.snowfall.BigSnowballCurse>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon BigSnowball To DrawPile_text", "Adicione <{a}> <card=shortcake.another.snowfall.BigSnowballCurse> ao topo de sua pilha de compra");
            table.AddEntry("shortcake.another.snowfall.When Deployed Instant Summon StoneTablet To DiscardPile_text", "Quando posto(a), adicione <{a}> <card=shortcake.another.snowfall.StoneTabletCurse> a sua pilha de descarte");
            table.AddEntry("shortcake.another.snowfall.Summon StoneTablet_text", "Invoque <card=shortcake.another.snowfall.StoneTabletCurse>");
            table.AddEntry("shortcake.another.snowfall.When Deployed Instant Summon StoneTablet3 To DiscardPile_text", "Quando posto(a), adicione <{a}> <card=shortcake.another.snowfall.StoneTabletCurse3> a sua pilha de descarte");
            table.AddEntry("shortcake.another.snowfall.Summon StoneTablet3_text", "Invoque <card=shortcake.another.snowfall.StoneTabletCurse3>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon BigShroom To DrawPile_text", "Adicione <{a}> <card=shortcake.another.snowfall.BigShroomCurse> ao topo de sua pilha de compra");
            table.AddEntry("shortcake.another.snowfall.Summon BigShroom_text", "Invoque <card=shortcake.another.snowfall.BigShroomCurse>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon BigShroom To DiscardPile_text", "Adicione <{a}> <card=shortcake.another.snowfall.BigShroomCurse> a sua pilha de descarte");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon StoneTablet2 To DiscardPile_text", "Adicione <{a}> <card=shortcake.another.snowfall.StoneTabletCurse2> a sua pilha de descarte");
            table.AddEntry("shortcake.another.snowfall.Summon StoneTablet2_text", "Invoque <card=shortcake.another.snowfall.StoneTabletCurse2>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon StoneTablet2 To DrawPile_text", "Adicione <{a}> <card=shortcake.another.snowfall.StoneTabletCurse2> ao topo de sua pilha de compra");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon StoneTablet2 To Hand_text", "Adicione <{a}> <card=shortcake.another.snowfall.StoneTabletCurse2> a sua mão");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon Arrow To Hand_text", "Adicione <{a}> <card=shortcake.another.snowfall.Arrow> a sua mão");
            table.AddEntry("shortcake.another.snowfall.Summon Arrow_text", "Invoque <card=shortcake.another.snowfall.Arrow>");
            table.AddEntry("shortcake.another.snowfall.Pre Turn Destroy All Curses In Hand & Add Attack And Health To Allies_text", "Destrua todas <keyword=shortcake.another.snowfall.curse> na mão e adicione <+{a}><keyword=attack>/<+{a}><keyword=health> para cada uma a todos aliados");
            table.AddEntry("shortcake.another.snowfall.On Card Played Destroy All Curses In Hand & Add Attack And Health To Allies_text", "Destrua todas <keyword=shortcake.another.snowfall.curse> na mão e adicione <+{a}><keyword=attack>/<+{a}><keyword=health> a um aliado aleatório para cada uma");
            table.AddEntry("shortcake.another.snowfall.When Curse Drawn, Destroy It And Apply Attack & Health To RandomAlly_text", "Quando uma <keyword=shortcake.another.snowfall.curse> for comprada, destrua-a e adicione <+{a}><keyword=attack>/<+{a}><keyword=health> a um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.When Curse Drawn, Destroy It And Apply Overload To RandomEnemy_text", "Quando uma <keyword=shortcake.another.snowfall.curse> for comprada, destrua-a e aplique <{a}><keyword=overload> a um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.When Curse Drawn, Increase Health And Attack To Self_text", "Quando uma <keyword=shortcake.another.snowfall.curse> for comprada, ganhe <+{a}><keyword=attack> e <+{a}><keyword=health>");
            table.AddEntry("shortcake.another.snowfall.Trigger When Curse Drawn_text", "Ativa quando uma <keyword=shortcake.another.snowfall.curse> for comprada");
            table.AddEntry("shortcake.another.snowfall.When Curse Drawn, Increase Attack Effects To Self_text", "Quando uma <keyword=shortcake.another.snowfall.curse> for comprada, aumente em {a}");
            table.AddEntry("shortcake.another.snowfall.When Hit Instant Summon Fog To DiscardPile_text", "Quando atingido(a), adicione <{a}> <card=shortcake.another.snowfall.FogCurse> a sua pilha de descarte");
            table.AddEntry("shortcake.another.snowfall.When Shroom Applied To Anything Double Amount_text", "Quando qualquer coisa receber <keyword=shroom>, dobre a quantidade");
            table.AddEntry("shortcake.another.snowfall.Pre Turn Double Spice To Self_text", "Antes de atacar, dobre a <keyword=spice>");
            table.AddEntry("shortcake.another.snowfall.When Ally is Hit Reduce Counter To Target_text", "Quando um aliando for atingido, diminua o <keyword=counter> dele em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Add Curse To Cards In Hand_text", "Adicione <keyword=shortcake.another.snowfall.curse> e <keyword=consume> a todos <itens> na sua mão");
            table.AddEntry("shortcake.another.snowfall.On Card Played Add Consume To Cards In Hand With Text_text", "Adicione <keyword=consume> a todos <itens> na sua mão");
            table.AddEntry("shortcake.another.snowfall.While Active Add Equal Attack To Items In Hand_text", "Enquanto ativo(a), adicione <keyword=attack> equivalente aos <Itens> na sua mão");
            table.AddEntry("shortcake.another.snowfall.When Destroyed, Transform Into InfernokoLeader2_text", "Quando a <keyword=health> chegar a 0 ou menos, <Transforme> em <card=shortcake.another.snowfall.InfernokoLeader2>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon Hog2 To Hand_text", "Adicione <{a}> <card=shortcake.another.snowfall.HogStarterAlly2> a sua mão");
            table.AddEntry("shortcake.another.snowfall.Summon Hog2_text", "Invoque <card=shortcake.another.snowfall.HogStarterAlly2>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon Beeberry2 To Hand_text", "Adicione <{a}> <card=shortcake.another.snowfall.BeeberryStarterAlly2> a sua mão");
            table.AddEntry("shortcake.another.snowfall.Summon Beeberry2_text", "Invoque <card=shortcake.another.snowfall.BeeberryStarterAlly2>");
            table.AddEntry("shortcake.another.snowfall.When Redraw Hit Apply Frenzy to Self_text", "Quando o <Sino de Recompra> for tocado, ganhe <x{a}><keyword=frenzy>");
            table.AddEntry("shortcake.another.snowfall.When Redraw Hit Reduce Counter to Self_text", "Quando o <Sino de Recompra> for tocado, diminua o <keyword=counter> em <{a}>");
            table.AddEntry("shortcake.another.snowfall.Bonus Damage Equal to Target's Frost_text", "Dê dano adicional igual ao <keyword=frost> do alvo");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Apply Block To RandomAlly_text", "Quando destruído(a), aplique <{a}><keyword=block> a um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.On Card Played Apply Frost To EnemiesInRow_text", "Aplique <{a}><keyword=frost> a inimigos na faixa");
            table.AddEntry("shortcake.another.snowfall.At End Of Turn Draw_text", "No fim de cada turno, descarte a carta mais à direita na sua mão e <keyword=draw> {a}");
            table.AddEntry("shortcake.another.snowfall.When Hit By Enemy Trigger To Self_text", "Ativa quando atingido(a) por um inimigo");
            table.AddEntry("shortcake.another.snowfall.On Card Played Trigger Again If Target Has Demonize_text", "Ativa contra alvos com <keyword=demonize>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Equal Damage To Frosted Target_text", "Dê dano adicional igual ao <keyword=frost> do alvo");
            table.AddEntry("shortcake.another.snowfall.Double Negative Effects With Text_text", "Dobre os debuffs do alvo");
            table.AddEntry("shortcake.another.snowfall.Double Shroom With Text_text", "Dobre o <keyword=shroom> do alvo");
            table.AddEntry("shortcake.another.snowfall.Instant Summon Bootleg Copy_text", "Invoque uma cópia <keyword=bootleg> de um aliado");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon Copy Of RandomEnemy At Enemy Row_text", "Invoque uma cópia de um inimigo aleatório");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon Copy Of RandomEnemy At Enemy Row With Half Health_text", "Invoque uma cópia de um inimigo aleatório com metade da <keyword=health>");
            table.AddEntry("shortcake.another.snowfall.When Deployed Summon Copy of Enemies With X Health2_text", "Quando posto(a), invoque cópias de todos inimigos com <{a}><keyword=health>");
            table.AddEntry("shortcake.another.snowfall.Trigger When Frost Applied To Anything_text", "Ativa quando qualquer coisa recebe <keyword=frost>");
            table.AddEntry("shortcake.another.snowfall.When Health Lost Apply Equal Teeth To Self_text", "Quando perder <keyword=health>, ganhe <keyword=teeth> equivalente");
            table.AddEntry("shortcake.another.snowfall.When Ally Is Killed Apply Frenzy To Self_text", "Ganhe <x{a}><keyword=frenzy> quando um aliado for morto");
            table.AddEntry("shortcake.another.snowfall.Trigger Against When AllyInRow Attacks_text", "Ativa contra o albo quando um aliado na faixa ataca");
            table.AddEntry("shortcake.another.snowfall.While Active Reduce Attack To Enemies (No Ping)_text", "Enquanto ativo(a), adicione <-{a}><keyword=attack> a todos inimigos");
            table.AddEntry("shortcake.another.snowfall.When Deployed Apply Frenzy To Self_text", "Quando posto(a), ganhe <x{a}><keyword=frenzy>");
            table.AddEntry("shortcake.another.snowfall.When Card Destroyed, Apply Shell To Allies_text", "Quando uma carta é destruída, aplique <{a}><keyword=shell> a todos aliados");
            table.AddEntry("shortcake.another.snowfall.When Enemy Deployed Ink To Target With Text_text", "Quando um inimigo é posto, aplique <{a}><keyword=null> a ele");
            table.AddEntry("shortcake.another.snowfall.When Hit Apply Haze To RandomEnemy_text", "Quando atingido(a) por um inimigo, aplique <{a}><keyword=haze> a um inimigo aleatório");
            table.AddEntry("shortcake.another.snowfall.At End Of Turn Add Fog To DiscardPile_text", "No fim de cada turno, adicione <{a}> <card=shortcake.another.snowfall.FogCurse> a sua pilha de descarte");
            table.AddEntry("shortcake.another.snowfall.While Active Halt Spice To Allies And Hand_text", "Enquanto ativo(a), todos aliados e <Itens> na sua mão retém <keyword=spice>");
            table.AddEntry("shortcake.another.snowfall.When Snow Applied To Anything Add Amount By 1_text", "Quando qualquer coisa receber <keyword=snow>, aumente a quantidade em 1");
            table.AddEntry("shortcake.another.snowfall.When Anyone Takes Shroom Damage Increase Max Health To Self_text", "Quando qualquer coisa tomar dano de <keyword=shroom>, ganhe <+{a}><keyword=health>");
            table.AddEntry("shortcake.another.snowfall.While In Hand Gain When Redraw Hit Destroy Self To Self_text", "Se na mão, se destrua quando o <Sino de Recompra> for tocado");
            table.AddEntry("shortcake.another.snowfall.While In Hand When Redraw Hit Apply Snow To All Allies To Self_text", "Se na mão, aplique <{a}><keyword=snow> a todos aliados e se destrua quando o <Sino de Recompra> for tocado");
            table.AddEntry("shortcake.another.snowfall.While In Hand When Redraw Hit Apply Shroom To All Allies To Self_text", "Se na mão, aplique <{a}><keyword=shroom> a todos aliados e se destrua quando o <Sino de Recompra> for tocado");
            table.AddEntry("shortcake.another.snowfall.While In Hand When Redraw Hit Apply Block To RandomEnemy To Self_text", "Se na mão, aplique <{a}><keyword=block> a um inimigo aleatório e se destrua quando o <Sino de Recompra> for tocado");
            table.AddEntry("shortcake.another.snowfall.While In Hand When Redraw Hit Apply Explode To RandomEnemy To Self_text", "Se na mão, aplique <keyword=explode> <{a}> a um inimigo aleatório e se destrua quando o <Sino de Recompra> for tocado");
            table.AddEntry("shortcake.another.snowfall.Bonus Damage Equal To Targets Frost For Items_text", "Dê dano adicional igual ao <keyword=frost> do alvo");
            table.AddEntry("shortcake.another.snowfall.Double Frost With Text_text", "Dobre o <keyword=frost> do alvo");
            table.AddEntry("shortcake.another.snowfall.When Redraw Hit Increase Attack To Self_text", "Quando o <Sino de Recompra> for tocado, ganhe <+{a}><keyword=attack>");
            table.AddEntry("shortcake.another.snowfall.When Redraw Hit Frenzy To Self_text", "Quando o <Sino de Recompra> for tocado, ganhe <x{a}><keyword=frenzy>");
            table.AddEntry("shortcake.another.snowfall.While Active Hold Shroom_text", "Enquanto ativo(a), <keyword=shroom> não pode diminuir para menos de <{a}>");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Apply Shroom To Attacker_text", "Quando destruído(a), aplique <{a}><keyword=shroom> ao atacante");
            table.AddEntry("shortcake.another.snowfall.Bonus Damage Equal To Targets Demonize With Count For Items_text", "Para cada <keyword=demonize> no alvo, dê <{a}> de dano adicional");
            table.AddEntry("shortcake.another.snowfall.Bonus Damage Equal To Targets Snow With Count For Items_text", "Para cada <keyword=snow> no alvo, dê <{a}> de dano adicional");
            table.AddEntry("shortcake.another.snowfall.Trigger Against Snowed Enemies_text", "Ativa contra um inimigo atingido por <keyword=snow>");
            table.AddEntry("shortcake.another.snowfall.Trigger Against Frosted Enemies_text", "Ativa contra um inimigo atingido por <keyword=frost>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Deploy HogStarterAlly2 To Board_text", "Posicione <{a}> <card=shortcake.another.snowfall.HogStarterAlly2>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Deploy BeeberryStarterAlly2 To Board_text", "Posicione <card=shortcake.another.snowfall.BeeberryStarterAlly2>");
            table.AddEntry("shortcake.another.snowfall.When Hit, Gain Equal Gold_text", "Quando atingido(a), largue <keyword=blings> equivalente");
            table.AddEntry("shortcake.another.snowfall.On Turn Swap Rows_text", "Mude as faixas");
            table.AddEntry("shortcake.another.snowfall.On Card Played Add Frenzy And Aimless To Items In Hand_text", "Adicione x{a}<keyword=frenzy> e <keyword=aimless> a todos <Itens> na sua mão");
            table.AddEntry("shortcake.another.snowfall.Instant Gain Spice Equal To Hand_text", "Aplique <keyword=spice> igual a cartas na sua mão");
            table.AddEntry("shortcake.another.snowfall.Instant Gain Shroom Equal To Hand_text", "Aplique <keyword=shroom> igual a cartas na sua mão");
            table.AddEntry("shortcake.another.snowfall.Halt Shroom_text", "Retém <keyword=shroom>");
            table.AddEntry("shortcake.another.snowfall.Instant Gain Halt Shroom_text", "Alvo retém <keyword=shroom>");
            table.AddEntry("shortcake.another.snowfall.Cleanse All Allies_text", "<keyword=cleanse> todos aliados");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Apply Block To AllUnit_text", "Quando destruído(a), aplique <{a}><keyword=block> a todos inimigos e aliados");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Boost To AllUnit_text", "Quando destruído(a), melhore os efeitos de todos inimigos em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Hit Equal Spice To FrontAlly_text", "Aplique <keyword=spice> ao aliado da frente igual ao dano dado");
            table.AddEntry("shortcake.another.snowfall.Hit All Allies_text", "Atinge todos aliados");
            table.AddEntry("shortcake.another.snowfall.Hit Random Ally For Unit_text", "Atinge um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.Hit Random Ally For Unit With Special Text_text", "Atinge um aliado ferido aleatório");
            table.AddEntry("shortcake.another.snowfall.Hit Random Ally For Unit With Special Text 2_text", "Atingo <Chikichi> ou um invocação aliada aleatória");
            table.AddEntry("shortcake.another.snowfall.Hit Random Enemy For Unit With Special Text_text", "Atinge um <Líder> aleatório");
            table.AddEntry("shortcake.another.snowfall.When Item Destroyed, Draw_text", "No final de cada turno, <keyword=draw {a}> para cada <Item> destruído neste turno");
            table.AddEntry("shortcake.another.snowfall.When Consumed Apply Block To RandomAlly_text", "Quando consumido(a), aplique <{a}><keyword=block> a um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.On Kill Heal To Allies_text", "Em abates, restaure <{a}><keyword=health> a todos aliados");
            table.AddEntry("shortcake.another.snowfall.On Card Played Count Down Redraw_text", "Diminua o <sprite name=counter> do <Sino de Recompra> em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Apply Shell To AllyBehind_text", "Aplique <{a}><keyword=shell> ao aliado atrás");
            table.AddEntry("shortcake.another.snowfall.While Active, Units Gains Attack On Turn_text", "Enquanto ativo(a), todos aliados e inimigos ganham <+{a}><keyword=attack> após ativar");
            table.AddEntry("shortcake.another.snowfall.When Redraw Hit Increase Attack Effects To Self Wherever_text", "Aumente em {a} quando o <Sino de Recompra> for tocado");
            table.AddEntry("shortcake.another.snowfall.If In Hand When Redraw Hit Increase Attack Effects To Self_text", "Aumente em {a} quando <keyword=shortcake.another.snowfall.retain> for usado");
            table.AddEntry("shortcake.another.snowfall.When Snow Applied To Self Gain Equal Attack Instead_text", "Quando receber <keyword=snow>, ganhe <keyword=attack> equivalente no lugar");
            table.AddEntry("shortcake.another.snowfall.Instant Gain When Snowed Gain Attack Instead_text", "Quando o alvo recever <keyword=snow>, ele ganhe <keyword=attack> equivalente no lugar");
            table.AddEntry("shortcake.another.snowfall.When Hit, Apply Equal Frost To EnemiesInRow_text", "Quando atingido(a), aplique <keyword=frost> equivalente a inimigos na faixa");
            table.AddEntry("shortcake.another.snowfall.InstantDiscard_text", "Descarte uma carta na mão");
            table.AddEntry("shortcake.another.snowfall.On Card Played Add Zoomlin To Random Card In Hand With Text_text", "Adicione <keyword=zoomlin> a uma carta aleatória na sua mão");
            table.AddEntry("shortcake.another.snowfall.Increase Max Health If Possible_text", "Aumente <keyword=health> em <{a}> se possível");
            table.AddEntry("shortcake.another.snowfall.Reduce Counter If Possible_text", "Diminua <keyword=counter> em <{a}> se possível");
            table.AddEntry("shortcake.another.snowfall.Instant Wash_text", "Remova todos efeitos de status do alvo");
            table.AddEntry("shortcake.another.snowfall.On Card Played Restore To Self & AlliesInRow_text", "Restaure <{a}><keyword=health> a si mesmo e aliados na faixa");
            table.AddEntry("shortcake.another.snowfall.When Card Destroyed, Gain Spice_text", "Quando uma carta for destruída, ganhe <{a}><keyword=spice>");
            table.AddEntry("shortcake.another.snowfall.Discard Self After Turn_text", "Se descarte após ativar");
            table.AddEntry("shortcake.another.snowfall.Instant Use Bom To Apply Shell To Random Enemy_text", "Use todos <keyword=weakness> no alvo e aplique <{a}><keyword=shell> a um aliado aleatório para cada <keyword=weakness>");
            table.AddEntry("shortcake.another.snowfall.When Deployed Boost To AllyBehind_text", "Quando posto(a), melhore os efeitos dos aliados na faixa em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Turn Apply Demonize To RandomEnemy Fixed_text", "Aplique <{a}><keyword=demonize> a um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.When Enemy Is Hit By Item Apply Frost To Them_text", "Quando um inimigo for atingido com um <Item>, aplique <{a}><keyword=frost> a ele");
            table.AddEntry("shortcake.another.snowfall.When Deployed Reduce Attack To Self_text", "Quando posto(a), perca <{a}><keyword=attack>");
            table.AddEntry("shortcake.another.snowfall.On Kill Increase Attack And Health To Self_text", "Ganhe <+{a}><keyword=attack> e <+{a}><keyword=health> em abates");
            table.AddEntry("shortcake.another.snowfall.While In Hand, Gain Frenzy Equal To Allies_text", "Quando posto(a), ganhe temporariamente <keyword=frenzy> equivalente ao número de aliados com <sprite name=counter>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Reduce Counter To RandomAlly Constrainted_text", "Diminua o <sprite name=counter> de um aliado aleatório em <{a}>");
            table.AddEntry("shortcake.another.snowfall.Instant Gain Shell Or Spice_text", "Aplique <{a}><keyword=shell> ou <{a}><keyword=spice>");
            table.AddEntry("shortcake.another.snowfall.When Reduce Counter, Also Reduce Max Counter_text", "Quando diminuído, também diminui <sprite name=counter>");
            table.AddEntry("shortcake.another.snowfall.Bombard Bombom_text", "<keyword=bombard>");
            table.AddEntry("shortcake.another.snowfall.Bombard Jumbo_text", "<keyword=bombard>");
            table.AddEntry("shortcake.another.snowfall.At End Of Turn Draw With Right Text_text", "No fim de cada turno, <keyword=draw> <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Reduce Max Counter_text", "Reduza o próprio <keyword=counter> em <{a}>");
            table.AddEntry("shortcake.another.snowfall.While Active Increase Effect To AllUnit_text", "Enquanto ativo(a), melhore os efeitos de todos aliados e inimigos em {a}");
            table.AddEntry("shortcake.another.snowfall.Instant Trigger Shroom_text", "Ativa o <keyword=shroom> do alvo");
            table.AddEntry("shortcake.another.snowfall.Hit Random Damaged Enemy For Unit_text", "Atinge um inimigo ferido aleatório");
            table.AddEntry("shortcake.another.snowfall.Hit All Frosted Enemies_text", "Atinge todos inimigos com  <keyword=frost>");
            table.AddEntry("shortcake.another.snowfall.Pre Trigger Destroy Rightmost Card And Gain Their Attack_text", "Antes de ativar, destrua a carta mais à direita na mão e ganhe seu <keyword=attack>");
            table.AddEntry("shortcake.another.snowfall.When Deployed Reduce Counter To Self_text", "Quando posto(a), diminua o <keyword=counter> em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Deploy OverFallowEnemy To Board_text", "Posicione <{a}> <card=shortcake.another.snowfall.OverFallowEnemy>");
            table.AddEntry("shortcake.another.snowfall.On Turn Heal & Cleanse Except Overload And Shroom To Allies_text", "Restaure <{a}><keyword=health> e <keyword=cleanse> todos aliados exceto os com <keyword=shroom> e <keyword=overload>");
            table.AddEntry("shortcake.another.snowfall.Bonus Damage Equal To Curse In Hand With Count_text", "Para cada <keyword=shortcake.another.snowfall.curse> na mão, dê <{a}> de dano adicional");
            table.AddEntry("shortcake.another.snowfall.Instant Gain Haze Equal To Frenzy_text", "Aplique <keyword=haze> igual à <keyword=frenzy> do alvo");
            table.AddEntry("shortcake.another.snowfall.Set Health To 0_text", "Defina a <keyword=health> de um aliado para 0");
            table.AddEntry("shortcake.another.snowfall.On Card Played Double Frost To RandomEnemy_text", "Dobre o <keyword=frost> de um inimigo aleatório");
            table.AddEntry("shortcake.another.snowfall.When Deployed Deploy Pets To Board_text", "Quando posto(a), posicione <{a}> pets aleatórios");
            table.AddEntry("shortcake.another.snowfall.When Destroyed, Transform Into FrostGuardianLeader2_text", "Quando a <keyword=health> chegar a 0 ou menos, <Transforme> em <card=shortcake.another.snowfall.FrostGuardianLeader2>");
            table.AddEntry("shortcake.another.snowfall.After Turn Consume Hand_text", "Após ativar, <keyword=consume> todos <Itens> na sua mão");
            table.AddEntry("shortcake.another.snowfall.Instant Super Yank_text", "<Super Gancho>");
            table.AddEntry("shortcake.another.snowfall.Bonus Damage Equal To Junk In Hand With Count_text", "Para cada <card=Junk> na mão, dê <{a}> de dano adicional");
            table.AddEntry("shortcake.another.snowfall.After Turn Consume All Junk_text", "Após ativar, <keyword=consume> todos <card=Junk> na sua mão");
            table.AddEntry("shortcake.another.snowfall.Prevent Curse_text", "Nega a(s) próxima(s) <{a}> <keyword=shortcake.another.snowfall.curse> que você obter");
            table.AddEntry("shortcake.another.snowfall.On Card Played Apply Frost Range P2 To Target_text", "Aplique <{am1}><-{ap1}><keyword=frost>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Apply Frost Range P4 To Target_text", "Aplique <{am2}><-{ap2}><keyword=frost>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Apply Frost Range P8 To Target_text", "Aplique <{am4}><-{ap4}><keyword=frost>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Apply Ink Range P2 To Target_text", "Aplique <{am1}><-{ap1}><keyword=null>");
            table.AddEntry("shortcake.another.snowfall.Double Negative Effects Fixed_text", "Dobre os efeitos negativos do alvo");
            table.AddEntry("shortcake.another.snowfall.Trigger Unstackable_text", "Ative o alvo");
            table.AddEntry("shortcake.another.snowfall.Split Unstackable_text", "<keyword=split> um aliado ou inimigo no campo");
            table.AddEntry("shortcake.another.snowfall.When Destroyed Summon DreggEnemy_text", "Quando destruído(a), invoque <card=shortcake.another.snowfall.DreggEnemy>");
            table.AddEntry("shortcake.another.snowfall.Summon DreggEnemy_text", "Invoque <card=shortcake.another.snowfall.DreggEnemy>");
            table.AddEntry("shortcake.another.snowfall.Hit Random Ally For Unit Haze Type_text", "Atinja um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.When Spice Applied To Allies Add Amount By 1_text", "Quando um aliado ganhar <keyword=spice>, aumente a quantidade em 1");
            table.AddEntry("shortcake.another.snowfall.While In Hand When Redraw Hit Apply Null To All Allies To Self_text", "Se na mão, aplique <{a}><keyword=null> a todos aliados e se destrua quando o <Sino de Recompra> for tocado");
            table.AddEntry("shortcake.another.snowfall.On Card Played Snow To RandomCard In Hand_text", "Aplique <{a}><keyword=snow> a uma carta aleatória na sua mão");
            table.AddEntry("shortcake.another.snowfall.Trigger Against Enemy When Snow Applied_text", "Ativa contra um inimigo atingido por <keyword=snow>");
            table.AddEntry("shortcake.another.snowfall.Trigger Against Enemy When Frost Applied_text", "Ativa contra um inimigo atingido por <keyword=frost>");
            table.AddEntry("shortcake.another.snowfall.Trigger Against Enemy When Bom Applied_text", "Ativa contra um inimigo atingido por <keyword=weakness>");
            table.AddEntry("shortcake.another.snowfall.While Active Halt Demonize To Enemies_text", "Equanto ativo(a), todos inimigos retém <keyword=demonize>");
            table.AddEntry("shortcake.another.snowfall.AddStatsWhenCharmed_text", "Quando receber um amuleto, ganhe <+{a}><keyword=attack> ou <+{a}><keyword=health>");
            table.AddEntry("shortcake.another.snowfall.When Hit Gain Block Once_text", "Quando atingido(a), ganhe <{a}><keyword=block> e perca este efeito");
            table.AddEntry("shortcake.another.snowfall.On Card Played Instant Summon Copy Of An Ally_text", "Invoque uma cópia de um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.On Card Played Increase Max Health To AlliesInRow_text", "Aumente <keyword=health> de todos aliados na faixa em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Add Health And Attack To RandomAlly_text", "Adicione <+{a}><keyword=attack> e <+{a}><keyword=health> a um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.On Card Played Reduce Max Counter To RandomAlly_text", "Reduza <keyword=counter> de um aliado aleatório em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Reduce Counter To RandomAlly_text", "Diminua o <keyword=counter> de um aliado aleatório em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Increase Max Health To RandomAlly_text", "Aumente a <keyword=health> de um aliado aleatório em <{a}>");
            table.AddEntry("shortcake.another.snowfall.On Card Played Double Spice To RandomAlly_text", "Dobre a <keyword=spice> de um aliado aleatório");
            table.AddEntry("shortcake.another.snowfall.On Card Played Frenzy And Increase Max Counter To RandomAlly_text", "Adicione <x{a}><keyword=frenzy> e aumente o <keyword=counter> em <{a}> de um aliado aleatório");
        }
        ...
        private void SetTooltipsLocalizations()
        {
            ...
            table.AddEntry("cobalt.wildfrost.bloons.uncharmable_title", "Sem Amuletos");
            table.AddEntry("cobalt.wildfrost.bloons.uncharmable_desc", "Amuletos não podem ser equipados");
            table.AddEntry("shortcake.another.snowfall.immunetoink_title", "Imune a Tinta");
            table.AddEntry("shortcake.another.snowfall.immunetoink_desc", "Não pode receber <sprite name=ink>");
            table.AddEntry("shortcake.another.snowfall.immunetohaze_title", "Imune a Névoa");
            table.AddEntry("shortcake.another.snowfall.immunetohaze_desc", "Não pode receber <sprite name=haze>");
            table.AddEntry("shortcake.another.snowfall.curse_title", "Maldição");
            table.AddEntry("shortcake.another.snowfall.curse_desc", "Tem efeitos negativos");
            table.AddEntry("shortcake.another.snowfall.retain_title", "Retenção");
            table.AddEntry("shortcake.another.snowfall.retain_desc", "Na Recompra, esta carta fica na sua mão");
            table.AddEntry("shortcake.another.snowfall.speed_title", "Velocidade");
            table.AddEntry("shortcake.another.snowfall.speed_desc", "Ativa antes de todos aliados e inimigos");
            table.AddEntry("shortcake.another.snowfall.limit_title", "Limite");
            table.AddEntry("shortcake.another.snowfall.limit_desc", "Será consumido(a) quando o limite chegar em 0");
            table.AddEntry("shortcake.another.snowfall.pincer_title", "Pinça");
            table.AddEntry("shortcake.another.snowfall.pincer_desc", "Atinge os alvos da ponta na faixa");
            table.AddEntry("shortcake.another.snowfall.untargetable_title", "Desvio");
            table.AddEntry("shortcake.another.snowfall.untargetable_desc", "Não pode ser alvo de inimigos ou itens de ataque");
            table.AddEntry("shortcake.another.snowfall.enemyitem_title", "Item Inimigo");
            table.AddEntry("shortcake.another.snowfall.enemyitem_desc", "Não pode ser alvo de inimigos ou itens\r\nEscape da batalha após ativação\r\nNão pode receber nenhum efeito de status\r\n<keyword=backline>");
        }
